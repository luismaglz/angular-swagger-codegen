...
export namespace Fee {
  export type ChargeLimitModeEnum =
    | "FirstOccurrences"
    | "LastOccurrences"
    | "FirstOutLastInOccurrences";
  export type ChargeLimitTravelComponentEnum =
    | "Unknown"
    | "Itinerary"
    | "Trip"
    | "Journey"
    ...
    | "Fare";
  export type FeeApplicationEnum =
    | "Pnr"
    | "TravelComponent"
    | "EachPassenger"
  ...
  export type FeeTypeEnum =
    ...
    | "ExtraBagFee"
    | "ATPCOBagFee";
  export type TaxApplicationEnum =
    | "Unknown"
    | "Taxable"
    | "TaxableLocal"
    | "NonTaxable"
    ...
    | "TaxableByTrip"
    | "TaxableByItinerary";
  export type TravelComponentEnum =
    | "Unknown"
    | "Itinerary"
    | "Trip"
    | "Journey"
