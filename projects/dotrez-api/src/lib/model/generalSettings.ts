...
export namespace GeneralSettings {
  export type AllowSeatAssignmentEnum =
    | "Never"
    | "OnlyOnUnheldBookings"
    | "Always";
  export type BookingAccessControlEnum =
    | "None"
    | "ScheduleOnly"
    | "Availability"
    | "View"
    ...
    | "Change"
    | "CreateAndChange";
  export type ViewBookingsByControlEnum =
    | "Agent"
    | "Organization"
    | "OrganizationGroup"
    | "All";
  export type EditBookingsByControlEnum =
    | "Agent"
    | "Organization"
    | "OrganizationGroup"
    | "All";
  ...
  export type ReassignSeatingBehaviorEnum =
    | "DropSeats"
    | "LikeForLike"
    | "Algorithm";
