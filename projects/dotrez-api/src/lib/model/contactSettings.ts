...
export namespace ContactSettings {
  export type TitleEnum =
    ...
    | "RequiredMasked"
    | "OptionalMasked";
  export type FirstNameEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type MiddleNameEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type LastNameEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type SuffixEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type AddressLineOneEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type AddressLineTwoEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type AddressLineThreeEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
  ...
  export type CountryEnum =
    ...
    | "RequiredMasked"
    | "OptionalMasked";
  export type EmailEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type HomePhoneNumberEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type WorkPhoneNumberEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type OtherPhoneNumberEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type FaxNumberEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DefaultItineraryDistributionEnum =
    | "None"
    | "Mail"
    | "Email"
    | "Fax"
