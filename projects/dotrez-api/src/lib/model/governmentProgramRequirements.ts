...
export interface GovernmentProgramRequirements {
   ...
   */
  requiredDocumentFields?: Array<
    GovernmentProgramRequirements.RequiredDocumentFieldsEnum
  >;
  /**
   * The collection of additional data that is required that are not related to documents.
   */
  additionalDataRequired?: Array<
    GovernmentProgramRequirements.AdditionalDataRequiredEnum
  >;
}
export namespace GovernmentProgramRequirements {
  export type RequiredDocumentFieldsEnum =
    | "FirstName"
    | "MiddleName"
    | "LastName"
    | "Title"
    ...
    | "IssuedDate"
    | "Verified";
  export type AdditionalDataRequiredEnum =
    | "CountryOfResidence"
    | "InTransitOrigin"
