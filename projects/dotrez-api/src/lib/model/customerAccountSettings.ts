...
export namespace CustomerAccountSettings {
  ...
  export type DefaultCustomerNotificationPreferenceEnum =
    | "None"
    | "Promotional";
  export type DefaultSeatPreferenceEnum =
    | "None"
    | "Window"
    | "Aisle"
    | "NoPreference"
    ...
    | "AisleFront"
    | "AisleRear";
  export type DisableCustomerAddressEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerCurrencyEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerDateOfBirthEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerEmailEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerFaxEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerLanguageEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerNationalityEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerNotificationPreferenceEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerPaymentEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerPhoneEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerResidentCountryEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerTitleEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
    | "OptionalMasked";
  export type DisableCustomerTypeEnum =
    | "Required"
    | "Optional"
    | "Disabled"
    | "RequiredMasked"
