...
export class FareRulesService {
    ...
    public apiNskV1FareRulesByFareAvailabilityKeyGet(fareAvailabilityKey: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (fareAvailabilityKey === null || fareAvailabilityKey === undefined) {
        ...
        return this.httpClient.get<FareRule>(`${this.basePath}/api/nsk/v1/fareRules/${encodeURIComponent(String(fareAvailabilityKey))}`,
            {
