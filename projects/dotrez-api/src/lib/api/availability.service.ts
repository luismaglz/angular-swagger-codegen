...
export class AvailabilityService {
  ...
  public apiNskV1AvailabilityLowfareBetaPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<LowFareCacheAvailability>>;
  public apiNskV1AvailabilityLowfareBetaPost(
    request?: LowFareCacheRequest,
    observe: any = "body",
    ...
    return this.httpClient.post<LowFareCacheAvailability>(
      `${this.basePath}/api/nsk/v1/availability/lowfare/beta`,
      request,
      {
  ...
  public apiNskV2AvailabilityLowfarePost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<LowFareAvailability>>;
  public apiNskV2AvailabilityLowfarePost(
    request?: LowFareAvailabilityRequest,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.post<LowFareAvailability>(
      `${this.basePath}/api/nsk/v2/availability/lowfare`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV2AvailabilityLowfareSimplePost(
    ...
    return this.httpClient.post<LowFareAvailability>(
      `${this.basePath}/api/nsk/v2/availability/lowfare/simple`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV4AvailabilitySearchPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Availabilityv2>>;
  public apiNskV4AvailabilitySearchPost(
    request?: AvailabilityRequestv2,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.post<Availabilityv2>(
      `${this.basePath}/api/nsk/v4/availability/search`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV4AvailabilitySearchSimplePost(
    ...
    return this.httpClient.post<Availabilityv2>(
      `${this.basePath}/api/nsk/v4/availability/search/simple`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
