...
export class VouchersService {
  ...
  public apiNskV1VouchersByDateGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<VouchersSummaryResponse>>;
  public apiNskV1VouchersByDateGet(
    beginDate: Date,
    pageSize?: number,
    lastPageKey?: string,
    ...
    return this.httpClient.get<VouchersSummaryResponse>(
      `${this.basePath}/api/nsk/v1/vouchers/byDate`,
      {
  ...
  public apiNskV1VouchersByIssuanceByVoucherIssuanceKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<VoucherItem>>>;
  public apiNskV1VouchersByIssuanceByVoucherIssuanceKeyGet(
    voucherIssuanceKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<Array<VoucherItem>>(
      `${this.basePath}/api/nsk/v1/vouchers/byIssuance/${encodeURIComponent(
        String(voucherIssuanceKey)
      )}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1VouchersByMarketGet(
    ...
    return this.httpClient.get<Array<VoucherItem>>(
      `${this.basePath}/api/nsk/v1/vouchers/byMarket`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1VouchersByVoucherKeyGet(
    ...
    return this.httpClient.get<Voucher>(
      `${this.basePath}/api/nsk/v1/vouchers/${encodeURIComponent(
        String(voucherKey)
      )}`,
      {
        withCredentials: this.configuration.withCredentials,
  ...
  public apiNskV1VouchersConfigurationByConfigurationCodeGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<VoucherConfiguration>>;
  public apiNskV1VouchersConfigurationByConfigurationCodeGet(
    configurationCode: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<VoucherConfiguration>(
      `${this.basePath}/api/nsk/v1/vouchers/configuration/${encodeURIComponent(
  ...
  public apiNskV1VouchersConfigurationGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<VoucherConfiguration>>>;
  public apiNskV1VouchersConfigurationGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<Array<VoucherConfiguration>>(
  ...
  public apiNskV1VouchersGet(
    ...
    return this.httpClient.get<Array<VoucherItem>>(
      `${this.basePath}/api/nsk/v1/vouchers`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
