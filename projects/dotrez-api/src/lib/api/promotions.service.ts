...
export class PromotionsService {
  ...
  public apiNskV1PromotionsByPromotionCodeGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Promotion>>;
  public apiNskV1PromotionsByPromotionCodeGet(
    promotionCode: string,
    observe: any = "body",
  ...
  public apiNskV1PromotionsByPromotionCodeValidateGet(
    ...
    return this.httpClient.get<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/promotions/${encodeURIComponent(
        String(promotionCode)
      )}/validate`,
      {
  ...
  public apiNskV1PromotionsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<PromotionBase>>>;
  public apiNskV1PromotionsGet(
    promotionCode?: string,
    organizationCode?: string,
    effectiveDate?: Date,
    ...
    if (promotionCodeMatching !== undefined && promotionCodeMatching !== null) {
      queryParameters = queryParameters.set(
        "PromotionCodeMatching",
        <any>promotionCodeMatching
      );
    }
    if (
      organizationCodeMatching !== undefined &&
      organizationCodeMatching !== null
    ) {
      queryParameters = queryParameters.set(
        "OrganizationCodeMatching",
        <any>organizationCodeMatching
      );
    }
    ...
    return this.httpClient.get<Array<PromotionBase>>(
      `${this.basePath}/api/nsk/v1/promotions`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
