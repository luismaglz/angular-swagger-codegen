...
export class BookingjourneysService {
  ...
  public apiNskV1BookingJourneysByJourneyKeyTravelDocumentRequirementsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<TravelDocumentRequirements>>;
  public apiNskV1BookingJourneysByJourneyKeyTravelDocumentRequirementsGet(
    journeyKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<TravelDocumentRequirements>(
      `${this.basePath}/api/nsk/v1/booking/journeys/${encodeURIComponent(
        String(journeyKey)
  ...
  public apiNskV1BookingJourneysGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<Journey>>>;
  public apiNskV1BookingJourneysGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<Array<Journey>>(
      `${this.basePath}/api/nsk/v1/booking/journeys`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
