...
export class Organizations2Service {
  ...
  public apiNskV1Organizations2ByOrganizationCodeAccountGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<OrganizationAccount>>;
  public apiNskV1Organizations2ByOrganizationCodeAccountGet(
    organizationCode: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<OrganizationAccount>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}/account`,
      {
  ...
  public apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<OrganizationCommissionRate>>;
  public apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeGet(
    organizationCode: string,
    commissionRateCode: string,
    observe: any = "body",
    ...
    return this.httpClient.get<OrganizationCommissionRate>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}/commissionRates/${encodeURIComponent(String(commissionRateCode))}`,
      {
  ...
  public apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<OrganizationExternalAccountv2>>;
  public apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyGet(
    organizationCode: string,
    externalAccountKey: string,
    observe: any = "body",
    ...
    return this.httpClient.get<OrganizationExternalAccountv2>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}/externalAccounts/${encodeURIComponent(String(externalAccountKey))}`,
      {
  ...
  public apiNskV1Organizations2ByOrganizationCodeGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Organizationv2>>;
  public apiNskV1Organizations2ByOrganizationCodeGet(
    organizationCode: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<Organizationv2>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}`,
      {
  ...
  public apiNskV1Organizations2ByOrganizationCodePatch(
    ...
    return this.httpClient.patch<Organizationv2>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}`,
      createRequest,
  ...
  public apiNskV1Organizations2ByOrganizationCodePut(
    ...
    return this.httpClient.put<Organizationv2>(
      `${this.basePath}/api/nsk/v1/organizations2/${encodeURIComponent(
        String(organizationCode)
      )}`,
      request,
  ...
  public apiNskV1Organizations2Post(
    ...
    return this.httpClient.post<Organizationv2>(
  ...
  public apiNskV2Organizations2Get(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<OrganizationRecord>>>;
  public apiNskV2Organizations2Get(
    type: "Default" | "Master" | "Carrier" | "TravelAgency" | "ThirdParty",
    status: "Default" | "Active" | "Cancelled" | "Pending",
    organizationCode?: string,
    ...
    if (
      parentOrganizationCode !== undefined &&
      parentOrganizationCode !== null
    ) {
      queryParameters = queryParameters.set(
        "ParentOrganizationCode",
        <any>parentOrganizationCode
      );
    }
    ...
    if (
      matchCriteriaOrganizationCode !== undefined &&
      matchCriteriaOrganizationCode !== null
    ) {
      queryParameters = queryParameters.set(
        "MatchCriteria.OrganizationCode",
        <any>matchCriteriaOrganizationCode
      );
    }
    if (
      matchCriteriaParentOrganizationCode !== undefined &&
      matchCriteriaParentOrganizationCode !== null
    ) {
      queryParameters = queryParameters.set(
        "MatchCriteria.ParentOrganizationCode",
        <any>matchCriteriaParentOrganizationCode
      );
    }
    if (
      matchCriteriaCompanyName !== undefined &&
      matchCriteriaCompanyName !== null
    ) {
      queryParameters = queryParameters.set(
        "MatchCriteria.CompanyName",
        <any>matchCriteriaCompanyName
      );
    }
    if (matchCriteriaCity !== undefined && matchCriteriaCity !== null) {
      queryParameters = queryParameters.set(
        "MatchCriteria.City",
        <any>matchCriteriaCity
      );
    }
    if (
      matchCriteriaPostalCode !== undefined &&
      matchCriteriaPostalCode !== null
    ) {
      queryParameters = queryParameters.set(
        "MatchCriteria.PostalCode",
        <any>matchCriteriaPostalCode
      );
    }
    ...
    return this.httpClient.get<Array<OrganizationRecord>>(
      `${this.basePath}/api/nsk/v2/organizations2`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
