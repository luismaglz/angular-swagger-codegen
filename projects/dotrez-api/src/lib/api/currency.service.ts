...
export class CurrencyService {
    ...
    public apiNskV1CurrencyConverterGet(fromCurrencyCode: string, toCurrencyCode: string, amount: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (fromCurrencyCode !== undefined && fromCurrencyCode !== null) {
            queryParameters = queryParameters.set('FromCurrencyCode', <any>fromCurrencyCode);
        }
        if (toCurrencyCode !== undefined && toCurrencyCode !== null) {
            queryParameters = queryParameters.set('ToCurrencyCode', <any>toCurrencyCode);
        }
        ...
        return this.httpClient.get<CurrencyConversion>(`${this.basePath}/api/nsk/v1/currency/converter`,
            {
