...
export class ManifestService {
  ...
  public apiNskV1ManifestByLegKeyPassengerDetailsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<PassengerDetails>>;
  public apiNskV1ManifestByLegKeyPassengerDetailsGet(
    legKey: string,
    observe: any = "body",
    ...
    return this.httpClient.get<PassengerDetails>(
      `${this.basePath}/api/nsk/v1/manifest/${encodeURIComponent(
        String(legKey)
      )}/passengerDetails`,
      {
  ...
  public apiNskV1ManifestByLegKeyPassengerSeatAssignmentsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<PassengerSeatAssignment>>>;
  public apiNskV1ManifestByLegKeyPassengerSeatAssignmentsGet(
    legKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<Array<PassengerSeatAssignment>>(
      `${this.basePath}/api/nsk/v1/manifest/${encodeURIComponent(
        String(legKey)
  ...
  public apiNskV1ManifestByLegKeyPost(
    ...
    return this.httpClient.post<Manifest>(
      `${this.basePath}/api/nsk/v1/manifest/${encodeURIComponent(
        String(legKey)
      )}`,
      request,
  ...
  public apiNskV1ManifestGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<TripInformationResponse>>;
  public apiNskV1ManifestGet(
    beginDate: Date,
    origin?: string,
    destination?: string,
    ...
    return this.httpClient.get<TripInformationResponse>(
      `${this.basePath}/api/nsk/v1/manifest`,
      {
