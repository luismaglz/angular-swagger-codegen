...
export class OrganizationsService {
    ...
    public apiNskV1OrganizationsGroupsByOrganizationGroupCodeGet(organizationGroupCode: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OrganizationGroupDetails>(`${this.basePath}/api/nsk/v1/organizations/groups/${encodeURIComponent(String(organizationGroupCode))}`,
            {
    ...
    public apiNskV1OrganizationsGroupsGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<OrganizationGroup>>(`${this.basePath}/api/nsk/v1/organizations/groups`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
