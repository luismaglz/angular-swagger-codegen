...
export class BookingboardingpassesService {
  ...
  public apiNskV1BookingBoardingpassesM2dJourneyByJourneyKeyPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<BoardingPassesM2D>>;
  public apiNskV1BookingBoardingpassesM2dJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassPassengerFilterRequest,
    observe: any = "body",
    ...
    return this.httpClient.post<BoardingPassesM2D>(
      `${
        this.basePath
  ...
  public apiNskV1BookingBoardingpassesS2dJourneyByJourneyKeyPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<BoardingPassesS2D>>;
  public apiNskV1BookingBoardingpassesS2dJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassPassengerFilterRequest,
    observe: any = "body",
    ...
    return this.httpClient.post<BoardingPassesS2D>(
      `${
        this.basePath
  ...
  public apiNskV3BookingBoardingpassesJourneyByJourneyKeyPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<BoardingPassesCollectionv2>>;
  public apiNskV3BookingBoardingpassesJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassFilterRequest,
    observe: any = "body",
    ...
    return this.httpClient.post<BoardingPassesCollectionv2>(
      `${
        this.basePath
