...
export class PersonsService {
  ...
  public apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyDelete(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/persons/${encodeURIComponent(
        String(personKey)
      )}/travelDocuments/${encodeURIComponent(
  ...
  public apiNskV1PersonsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<PersonRecord>>>;
  public apiNskV1PersonsGet(
    activeOnly: boolean,
    firstName?: string,
    lastName?: string,
    ...
    if (nationalIdNumber !== undefined && nationalIdNumber !== null) {
      queryParameters = queryParameters.set(
        "NationalIdNumber",
        <any>nationalIdNumber
      );
    }
    if (
      nationalIdNumberMatching !== undefined &&
      nationalIdNumberMatching !== null
    ) {
      queryParameters = queryParameters.set(
        "NationalIdNumberMatching",
        <any>nationalIdNumberMatching
      );
    }
    ...
    return this.httpClient.get<Array<PersonRecord>>(
      `${this.basePath}/api/nsk/v1/persons`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPatch(
    ...
    return this.httpClient.patch<IJsonResponse>(
      `${this.basePath}/api/nsk/v2/persons/${encodeURIComponent(
        String(personKey)
      )}/travelDocuments/${encodeURIComponent(
        String(personTravelDocumentKey)
      )}`,
