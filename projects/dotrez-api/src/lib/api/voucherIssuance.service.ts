...
export class VoucherIssuanceService {
  ...
  public apiNskV1VoucherIssuanceByVoucherIssuanceKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<VoucherIssuance>>;
  public apiNskV1VoucherIssuanceByVoucherIssuanceKeyGet(
    voucherIssuanceKey: string,
    observe: any = "body",
    ...
    return this.httpClient.get<VoucherIssuance>(
      `${this.basePath}/api/nsk/v1/voucherIssuance/${encodeURIComponent(
  ...
  public apiNskV1VoucherIssuancePost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/voucherIssuance`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
