...
export class BookingssrsService {
  ...
  public apiNskV1BookingSsrsBySsrKeyDelete(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/booking/ssrs/${encodeURIComponent(
        String(ssrKey)
      )}`,
      {
  ...
  public apiNskV1BookingSsrsBySsrKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<PassengerSsr>>;
  public apiNskV1BookingSsrsBySsrKeyGet(
    ssrKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<PassengerSsr>(
      `${this.basePath}/api/nsk/v1/booking/ssrs/${encodeURIComponent(
        String(ssrKey)
      )}`,
      {
  ...
  public apiNskV1BookingSsrsGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<PassengerSsr>>>;
  public apiNskV1BookingSsrsGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<Array<PassengerSsr>>(
  ...
  public apiNskV1BookingSsrsManualDelete(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/booking/ssrs/manual`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public apiNskV1BookingSsrsResellPost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/booking/ssrs/resell`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV2BookingSsrsAvailabilityPost(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<SsrAvailability>>;
  public apiNskV2BookingSsrsAvailabilityPost(
    request?: SsrAvailabilityRequestv2,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.post<SsrAvailability>(
      `${this.basePath}/api/nsk/v2/booking/ssrs/availability`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV2BookingSsrsBySsrKeyPost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v2/booking/ssrs/${encodeURIComponent(
        String(ssrKey)
      )}`,
      request,
      {
  ...
  public apiNskV2BookingSsrsPost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v2/booking/ssrs`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
