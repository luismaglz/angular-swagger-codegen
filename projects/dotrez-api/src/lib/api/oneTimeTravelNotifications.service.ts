...
export class OneTimeTravelNotificationsService {
  ...
  public apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyDelete(
    ...
    if (
      oneTimeTravelNotificationKey === null ||
      oneTimeTravelNotificationKey === undefined
    ) {
      throw new Error(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${
        this.basePath
      }/api/nsk/v1/oneTimeTravelNotifications/${encodeURIComponent(
        String(oneTimeTravelNotificationKey)
      )}`,
      {
  ...
  public apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<OneTimeTravelNotification>>;
  public apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyGet(
    oneTimeTravelNotificationKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<OneTimeTravelNotification>(
      `${
        this.basePath
      }/api/nsk/v1/oneTimeTravelNotifications/${encodeURIComponent(
        String(oneTimeTravelNotificationKey)
  ...
  public apiNskV1OneTimeTravelNotificationsPost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/oneTimeTravelNotifications`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
