...
export class TokenService {
  ...
  public apiNskV1TokenCulturePost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/token/culture`,
      null,
      {
  ...
  public apiNskV1TokenDelete(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/token`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public apiNskV1TokenGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<NskSessionContext>>;
  public apiNskV1TokenGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<NskSessionContext>(
      `${this.basePath}/api/nsk/v1/token`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1TokenServerTransferPost(
    ...
    return this.httpClient.post<TokenResponse>(
      `${this.basePath}/api/nsk/v1/token/serverTransfer`,
      request,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1TokenSingleSignOnPost(
    ...
    return this.httpClient.post<TokenResponse>(
      `${this.basePath}/api/nsk/v1/token/singleSignOn`,
      credentials,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
