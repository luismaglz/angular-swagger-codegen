...
export class QueuesService {
  ...
  public apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyDelete(
    ...
    return this.httpClient.delete<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/queues/bookings/${encodeURIComponent(
        String(bookingQueueCode)
      )}/items/${encodeURIComponent(String(bookingQueueItemKey))}`,
      {
  ...
  public apiNskV1QueuesTravelByTravelQueueCodeNextGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<DequeueTravelSummary>>;
  public apiNskV1QueuesTravelByTravelQueueCodeNextGet(
    travelQueueCode: string,
    subQueueCode?: string,
    observe: any = "body",
    ...
    return this.httpClient.get<DequeueTravelSummary>(
  ...
  public apiNskV1QueuesTravelPost(
    ...
    return this.httpClient.post<IJsonResponse>(
      `${this.basePath}/api/nsk/v1/queues/travel`,
      item,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV2QueuesBookingsByBookingQueueCodeNextGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<BookingQueueItemBase>>>;
  public apiNskV2QueuesBookingsByBookingQueueCodeNextGet(
    bookingQueueCode: string,
    subQueueCode?: string,
    startDate?: Date,
    ...
    return this.httpClient.get<Array<BookingQueueItemBase>>(
  ...
  public apiNskV2QueuesBookingsGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<QueueResults>>;
  public apiNskV2QueuesBookingsGet(
    queueName?: string,
    queueCode?: string,
    queueCategoryCode?: string,
    ...
    return this.httpClient.get<QueueResults>(
      `${this.basePath}/api/nsk/v2/queues/bookings`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
