...
export class UserService {
  ...
  public apiNskV1UserBookingsByPassengerGet(
    ...
    return this.httpClient.get<Array<BookingTripResult>>(
      `${this.basePath}/api/nsk/v1/user/bookingsByPassenger`,
      {
  ...
  public apiNskV1UserBookingsGet(
    ...
    return this.httpClient.get<Array<BookingSearchResult>>(
      `${this.basePath}/api/nsk/v1/user/bookings`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1UserImpersonateGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<SessionRoles>>;
  public apiNskV1UserImpersonateGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<SessionRoles>(
      `${this.basePath}/api/nsk/v1/user/impersonate`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public apiNskV1UserSingleSignOnTokenByProviderKeyGet(
    ...
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<UserSingleSignOnToken>>;
  public apiNskV1UserSingleSignOnTokenByProviderKeyGet(
    providerKey: string,
    observe: any = "body",
    reportProgress: boolean = false
    ...
    return this.httpClient.get<UserSingleSignOnToken>(
      `${this.basePath}/api/nsk/v1/user/singleSignOnToken/${encodeURIComponent(
        String(providerKey)
      )}`,
      {
  ...
  public apiNskV1UserSingleSignOnTokenGet(
    observe?: "events",
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<UserSingleSignOnToken>>>;
  public apiNskV1UserSingleSignOnTokenGet(
    observe: any = "body",
    reportProgress: boolean = false
  ): Observable<any> {
    ...
    return this.httpClient.get<Array<UserSingleSignOnToken>>(
