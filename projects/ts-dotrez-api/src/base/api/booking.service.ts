...
export class BookingService {
  ...
  public apiNskV1BookingAddonsByAddOnKeyGet(
    ...
    const response: Observable<HttpResponse<AddOn>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/booking/addons/${encodeURIComponent(
        String(addOnKey)
      )}`,
      headers
  ...
  public apiNskV1BookingHistoryNotificationGet(
    ...
    const response: Observable<HttpResponse<
      Array<BookingNotificationHistory>
    >> = this.httpClient.get(
    ...
    if (observe == "body") {
      return response.pipe(
        map(
          httpResponse =>
            <Array<BookingNotificationHistory>>httpResponse.response
        )
      );
    }
    return response;
