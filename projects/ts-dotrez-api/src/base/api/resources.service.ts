...
export class ResourcesService {
  ...
  public apiNskV1ResourcesAddOnsSourcesBySourceCodeGet(
    ...
    const response: Observable<HttpResponse<Source>> = this.httpClient.get(
      `${
        this.basePath
  ...
  public apiNskV1ResourcesDomainsByDomainCodeGet(
    ...
    const response: Observable<HttpResponse<Domain>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/Domains/${encodeURIComponent(
        String(domainCode)
      )}`,
      headers
    );
  ...
  public apiNskV1ResourcesMacsByMacCodeGet(
    ...
    const response: Observable<HttpResponse<Mac>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/Macs/${encodeURIComponent(
        String(macCode)
      )}`,
      headers
    );
  ...
  public apiNskV1ResourcesPersonAttachmentTypesGet(
    ...
    if (observe == 'body') {
      return response.pipe(
        map(
          httpResponse =>
            <ResourceEntriesPersonAttachmentType>httpResponse.response
        )
      );
    }
    return response;
  ...
  public apiNskV1ResourcesReminderTimesByTimedEventTypeGet(
    ...
    const response: Observable<HttpResponse<
      ProvinceState
    >> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/reminderTimes/${encodeURIComponent(
        String(timedEventType)
      )}`,
      headers
    );
    if (observe == 'body') {
  ...
  public apiNskV1ResourcesRoleSettingTypesByRoleSettingTypeCodeGet(
    ...
    >> = this.httpClient.get(
      `${
        this.basePath
      }/api/nsk/v1/resources/RoleSettingTypes/${encodeURIComponent(
        String(roleSettingTypeCode)
      )}`,
      headers
    );
    if (observe == 'body') {
  ...
  public apiNskV1ResourcesRolesByRoleCodeGet(
    ...
    const response: Observable<HttpResponse<Role>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/roles/${encodeURIComponent(
        String(roleCode)
      )}`,
      headers
    );
  ...
  public apiNskV1ResourcesSingleSignOnProviderByProviderNameGet(
    ...
    >> = this.httpClient.get(
      `${
        this.basePath
      }/api/nsk/v1/resources/singleSignOnProvider/${encodeURIComponent(
        String(providerName)
      )}`,
      headers
    );
  ...
  public apiNskV1ResourcesSuffixesBySuffixCodeGet(
    ...
    const response: Observable<HttpResponse<Suffix>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/Suffixes/${encodeURIComponent(
        String(suffixCode)
      )}`,
      headers
    );
  ...
  public apiNskV1ResourcesTitlesByTitleKeyGet(
    ...
    const response: Observable<HttpResponse<Title>> = this.httpClient.get(
      `${this.basePath}/api/nsk/v1/resources/Titles/${encodeURIComponent(
        String(titleKey)
      )}`,
      headers
    );
  ...
  public apiNskV2ResourcesCurrenciesControllerv2ByCurrencyCodeGet(
    ...
    const response: Observable<HttpResponse<Currency>> = this.httpClient.get(
      `${
        this.basePath
  ...
  public apiNskV2ResourcesMarketsByLocationCodeByTravelLocationCodeGet(
    ...
    const response: Observable<HttpResponse<Market>> = this.httpClient.get(
