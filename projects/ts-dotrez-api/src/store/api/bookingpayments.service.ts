...
export class StoreBookingpaymentsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BookingpaymentsService") protected baseService:BookingpaymentsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsByPaymentKeyDelete(paymentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsByPaymentKeyGet(paymentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsRefundsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsRefundsOrganizationCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsVoucherByVoucherPaymentReferenceDelete(voucherPaymentReference,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPaymentsVoucherGet(referenceCode,overrideRestrictions,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsAvailableGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsBookingCreditGet(recordLocator,currencyCode,emailAddress,origin,firstName,lastName,customerNumber,departureDate,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsBookingCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsCreditGet(referenceNumber,type,currencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsCustomerCreditGet(currencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsCustomerCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsOrganizationCreditGet(currencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsOrganizationCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsPost(request,termUrl,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsRefundsCustomerCreditPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingPaymentsVoucherByVoucherPaymentReferenceDelete(voucherPaymentReference,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsByPaymentMethodDccGet(paymentMethod,amount,accountNumber,quotedCurrencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsFeesByFeeCodeGet(feeCode,amount,currencyCode,collectedCurrencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsMccByCurrencyCodePost(currencyCode,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsMccByCurrencyCodeStoredPaymentByStoredPaymentKeyPost(currencyCode,storedPaymentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsMccGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsRefundsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsStoredPaymentByStoredPaymentKeyPost(storedPaymentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsThreeDSecurePost(request,termUrl,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPaymentsVoucherPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV4BookingPaymentsDccByDccKeyPost(dccKey,request,'body', headers).toPromise();
