...
export class StoreBookingpaymentsService {
  ...
  public async store_apiNskV1BookingPaymentsByPaymentKeyDelete(
    ...
    const response = await apiNskV1BookingPaymentsByPaymentKeyDelete(
      paymentKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPaymentsByPaymentKeyGet(
    ...
    const response = await apiNskV1BookingPaymentsByPaymentKeyGet(
      paymentKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPaymentsGet(
    ...
    const response = await apiNskV1BookingPaymentsGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPaymentsRefundsGet(
    ...
    const response = await apiNskV1BookingPaymentsRefundsGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPaymentsRefundsOrganizationCreditPost(
    ...
    const response = await apiNskV1BookingPaymentsRefundsOrganizationCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPaymentsVoucherByVoucherPaymentReferenceDelete(
    ...
    const response = await apiNskV1BookingPaymentsVoucherByVoucherPaymentReferenceDelete(
  ...
  public async store_apiNskV1BookingPaymentsVoucherGet(
    ...
    const response = await apiNskV1BookingPaymentsVoucherGet(
      referenceCode,
  ...
  public async store_apiNskV2BookingPaymentsAvailableGet(
    ...
    const response = await apiNskV2BookingPaymentsAvailableGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsBookingCreditGet(
    ...
    const response = await apiNskV2BookingPaymentsBookingCreditGet(
      recordLocator,
      currencyCode,
      emailAddress,
      origin,
  ...
  public async store_apiNskV2BookingPaymentsBookingCreditPost(
    ...
    const response = await apiNskV2BookingPaymentsBookingCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsCreditGet(
    ...
    const response = await apiNskV2BookingPaymentsCreditGet(
      referenceNumber,
      type,
      currencyCode,
      "body",
  ...
  public async store_apiNskV2BookingPaymentsCreditPost(
    ...
    const response = await apiNskV2BookingPaymentsCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsCustomerCreditGet(
    ...
    const response = await apiNskV2BookingPaymentsCustomerCreditGet(
      currencyCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsCustomerCreditPost(
    ...
    const response = await apiNskV2BookingPaymentsCustomerCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsOrganizationCreditGet(
    ...
    const response = await apiNskV2BookingPaymentsOrganizationCreditGet(
      currencyCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsOrganizationCreditPost(
    ...
    const response = await apiNskV2BookingPaymentsOrganizationCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsPost(
    ...
    const response = await apiNskV2BookingPaymentsPost(
      request,
      termUrl,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPaymentsRefundsCustomerCreditPost(
    ...
    const response = await apiNskV2BookingPaymentsRefundsCustomerCreditPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPaymentsVoucherByVoucherPaymentReferenceDelete(
    ...
    const response = await apiNskV2BookingPaymentsVoucherByVoucherPaymentReferenceDelete(
      voucherPaymentReference,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV3BookingPaymentsByPaymentMethodDccGet(
    ...
    const response = await apiNskV3BookingPaymentsByPaymentMethodDccGet(
      paymentMethod,
      amount,
      accountNumber,
      quotedCurrencyCode,
  ...
  public async store_apiNskV3BookingPaymentsFeesByFeeCodeGet(
    ...
    const response = await apiNskV3BookingPaymentsFeesByFeeCodeGet(
      feeCode,
      amount,
      currencyCode,
  ...
  public async store_apiNskV3BookingPaymentsMccByCurrencyCodePost(
    ...
    const response = await apiNskV3BookingPaymentsMccByCurrencyCodePost(
      currencyCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV3BookingPaymentsMccByCurrencyCodeStoredPaymentByStoredPaymentKeyPost(
    ...
    const response = await apiNskV3BookingPaymentsMccByCurrencyCodeStoredPaymentByStoredPaymentKeyPost(
      currencyCode,
      storedPaymentKey,
      request,
      "body",
  ...
  public async store_apiNskV3BookingPaymentsMccGet(
    ...
    const response = await apiNskV3BookingPaymentsMccGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV3BookingPaymentsRefundsPost(
    ...
    const response = await apiNskV3BookingPaymentsRefundsPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV3BookingPaymentsStoredPaymentByStoredPaymentKeyPost(
    ...
    const response = await apiNskV3BookingPaymentsStoredPaymentByStoredPaymentKeyPost(
      storedPaymentKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV3BookingPaymentsThreeDSecurePost(
    ...
    const response = await apiNskV3BookingPaymentsThreeDSecurePost(
      request,
      termUrl,
      "body",
      headers
  ...
  public async store_apiNskV3BookingPaymentsVoucherPost(
    ...
    const response = await apiNskV3BookingPaymentsVoucherPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV4BookingPaymentsDccByDccKeyPost(
    ...
    const response = await apiNskV4BookingPaymentsDccByDccKeyPost(
      dccKey,
      request,
      "body",
      headers
