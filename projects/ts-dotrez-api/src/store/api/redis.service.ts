...
export class StoreRedisService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("RedisService") protected baseService:RedisService) {}
    ...
    {
        const response = await this.baseService.apiV1RedisByNameDelete(name,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1RedisDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1RedisGet('body', headers).toPromise();
