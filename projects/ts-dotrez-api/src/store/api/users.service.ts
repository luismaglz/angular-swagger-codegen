...
export class StoreUsersService {
   ...
   */
  public async store_apiNskV1UsersByUserKeyBookingsByPassengerGet(
    userKey: string,
    startDate?: Date,
    endDate?: Date,
    headers?: Headers
  ): Promise<Array<BookingTripResult>> {
    const response = await apiNskV1UsersByUserKeyBookingsByPassengerGet(
      userKey,
      startDate,
      endDate,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyBookingsGet(
    userKey: string,
    returnCount: number,
    ...
    const response = await apiNskV1UsersByUserKeyBookingsGet(
      userKey,
      returnCount,
      associatedFirstName,
      associatedLastName,
   ...
   */
  public async store_apiNskV1UsersByUserKeyDelete(
    userKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyDelete(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyGet(
    userKey: string,
    headers?: Headers
  ): Promise<User> {
    const response = await apiNskV1UsersByUserKeyGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPasswordChangePost(
    userKey: string,
    request?: UserChangePasswordRequestBase,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPasswordChangePost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPasswordResetPost(
    userKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPasswordResetPost(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPatch(
    userKey: string,
    request?: DeltaMapperUserRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPatch(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyDelete(
    userKey: string,
    personAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyDelete(
      userKey,
      personAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyGet(
    userKey: string,
    personAddressKey: string,
    headers?: Headers
  ): Promise<PersonAddress> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyGet(
      userKey,
      personAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyPatch(
    userKey: string,
    personAddressKey: string,
    request?: DeltaMapperPersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyPatch(
      userKey,
      personAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyPut(
    userKey: string,
    personAddressKey: string,
    request?: PersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesByPersonAddressKeyPut(
      userKey,
      personAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonAddress>> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAddressesPost(
    userKey: string,
    request?: PersonAddressCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAddressesPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyDelete(
    userKey: string,
    personAliasKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyDelete(
      userKey,
      personAliasKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyGet(
    userKey: string,
    personAliasKey: string,
    headers?: Headers
  ): Promise<PersonAlias> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyGet(
      userKey,
      personAliasKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyPatch(
    userKey: string,
    personAliasKey: string,
    request?: DeltaMapperPersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyPatch(
      userKey,
      personAliasKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyPut(
    userKey: string,
    personAliasKey: string,
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesByPersonAliasKeyPut(
      userKey,
      personAliasKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonAlias>> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonAliasesPost(
    userKey: string,
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonAliasesPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyDelete(
    userKey: string,
    personCommentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyDelete(
      userKey,
      personCommentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyGet(
    userKey: string,
    personCommentKey: string,
    headers?: Headers
  ): Promise<PersonComment> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyGet(
      userKey,
      personCommentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyPatch(
    userKey: string,
    personCommentKey: string,
    request?: DeltaMapperPersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyPatch(
      userKey,
      personCommentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyPut(
    userKey: string,
    personCommentKey: string,
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsByPersonCommentKeyPut(
      userKey,
      personCommentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonComment>> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonCommentsPost(
    userKey: string,
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonCommentsPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyDelete(
    userKey: string,
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyGet(
    userKey: string,
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<PersonEmail> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyGet(
      userKey,
      personEmailAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPatch(
    userKey: string,
    personEmailAddressKey: string,
    request?: DeltaMapperPersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPatch(
      userKey,
      personEmailAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPost(
    userKey: string,
    personEmailAddressKey: string,
    request?: PersonEmailCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPost(
      userKey,
      personEmailAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPut(
    userKey: string,
    personEmailAddressKey: string,
    request?: PersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsByPersonEmailAddressKeyPut(
      userKey,
      personEmailAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonEmailsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonEmail>> {
    const response = await apiNskV1UsersByUserKeyPersonEmailsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonGet(
    userKey: string,
    headers?: Headers
  ): Promise<Person> {
    const response = await apiNskV1UsersByUserKeyPersonGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyDelete(
    userKey: string,
    personInformationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyGet(
    userKey: string,
    personInformationKey: string,
    headers?: Headers
  ): Promise<PersonInformation> {
    const response = await apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyGet(
      userKey,
      personInformationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyPatch(
    userKey: string,
    personInformationKey: string,
    request?: DeltaMapperPersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyPatch(
      userKey,
      personInformationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyPut(
    userKey: string,
    personInformationKey: string,
    request?: PersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonInformationByPersonInformationKeyPut(
      userKey,
      personInformationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonInformation>> {
    const response = await apiNskV1UsersByUserKeyPersonInformationGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonInformationPost(
    userKey: string,
    request?: PersonInformationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonInformationPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPatch(
    userKey: string,
    request?: DeltaMapperPersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPatch(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyDelete(
    userKey: string,
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyGet(
    userKey: string,
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<PersonPhoneNumber> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyGet(
      userKey,
      personPhoneNumberKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyPatch(
    userKey: string,
    personPhoneNumberKey: string,
    request?: DeltaMapperPersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyPatch(
      userKey,
      personPhoneNumberKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyPut(
    userKey: string,
    personPhoneNumberKey: string,
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersByPersonPhoneNumberKeyPut(
      userKey,
      personPhoneNumberKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonPhoneNumber>> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPhoneNumbersPost(
    userKey: string,
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPhoneNumbersPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyDelete(
    userKey: string,
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyDelete(
      userKey,
      personPreferenceKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyGet(
    userKey: string,
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<PersonPreference> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyGet(
      userKey,
      personPreferenceKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyPatch(
    userKey: string,
    personPreferenceKey: string,
    request?: DeltaMapperPersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyPatch(
      userKey,
      personPreferenceKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyPut(
    userKey: string,
    personPreferenceKey: string,
    request?: PersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesByPersonPreferenceKeyPut(
      userKey,
      personPreferenceKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonPreference>> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPreferencesPost(
    userKey: string,
    request?: PersonPreferenceCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPreferencesPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyDelete(
    userKey: string,
    personProgramKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyDelete(
      userKey,
      personProgramKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyGet(
    userKey: string,
    personProgramKey: string,
    headers?: Headers
  ): Promise<PersonCustomerProgram> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyGet(
      userKey,
      personProgramKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyPatch(
    userKey: string,
    personProgramKey: string,
    request?: DeltaMapperPersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyPatch(
      userKey,
      personProgramKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyPut(
    userKey: string,
    personProgramKey: string,
    request?: PersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsByPersonProgramKeyPut(
      userKey,
      personProgramKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonCustomerProgram>> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonProgramsPost(
    userKey: string,
    request?: PersonCustomerProgramCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonProgramsPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonPut(
    userKey: string,
    request?: PersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonPut(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyDelete(
    userKey: string,
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyGet(
    userKey: string,
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<PersonStoredPayment> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyGet(
      userKey,
      personStoredPaymentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyPatch(
    userKey: string,
    personStoredPaymentKey: string,
    request?: DeltaMapperPersonStoredPaymentUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyPatch(
      userKey,
      personStoredPaymentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyPut(
    userKey: string,
    personStoredPaymentKey: string,
    request?: PersonStoredPaymentUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsByPersonStoredPaymentKeyPut(
      userKey,
      personStoredPaymentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonStoredPayment>> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonStoredPaymentsPost(
    userKey: string,
    request?: PersonStoredPaymentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonStoredPaymentsPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyDelete(
    userKey: string,
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyGet(
    userKey: string,
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<PersonTravelDocument> {
    const response = await apiNskV1UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyGet(
      userKey,
      personTravelDocumentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelDocumentsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<PersonTravelDocument>> {
    const response = await apiNskV1UsersByUserKeyPersonTravelDocumentsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelDocumentsPost(
    userKey: string,
    request?: PersonTravelDocumentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelDocumentsPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyDelete(
    userKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyDelete(
      userKey,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
    userKey: string,
    travelNotificationKey: string,
    eventType: "DepartureDelay" | "ArrivalDelay" | "ScheduleChange" | "CheckIn",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
      userKey,
      travelNotificationKey,
      eventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
    userKey: string,
    travelNotificationKey: string,
    eventType: "DepartureDelay" | "ArrivalDelay" | "ScheduleChange" | "CheckIn",
    headers?: Headers
  ): Promise<NotificationEvent> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
      userKey,
      travelNotificationKey,
      eventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsGet(
    userKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationEvent>> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsGet(
      userKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsPost(
    userKey: string,
    travelNotificationKey: string,
    request?: NotificationEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyEventsPost(
      userKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyGet(
    userKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<TravelNotification> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyGet(
      userKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyPatch(
    userKey: string,
    travelNotificationKey: string,
    request?: DeltaMapperTravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyPatch(
      userKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyPut(
    userKey: string,
    travelNotificationKey: string,
    request?: TravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyPut(
      userKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
    userKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
      userKey,
      travelNotificationKey,
      timedEventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
    userKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    headers?: Headers
  ): Promise<NotificationTimedEvent> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
      userKey,
      travelNotificationKey,
      timedEventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
    userKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    ...
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
      userKey,
      travelNotificationKey,
      timedEventType,
      request,
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsGet(
    userKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationTimedEvent>> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsGet(
      userKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsPost(
    userKey: string,
    travelNotificationKey: string,
    request?: NotificationTimedEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsByTravelNotificationKeyTimedEventsPost(
      userKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<TravelNotification>> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPersonTravelNotificationsPost(
    userKey: string,
    request?: TravelNotificationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPersonTravelNotificationsPost(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyPut(
    userKey: string,
    request?: UserRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyPut(
      userKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesByUserRoleKeyDelete(
    userKey: string,
    userRoleKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyRolesByUserRoleKeyDelete(
      userKey,
      userRoleKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesByUserRoleKeyGet(
    userKey: string,
    userRoleKey: string,
    headers?: Headers
  ): Promise<UserRole> {
    const response = await apiNskV1UsersByUserKeyRolesByUserRoleKeyGet(
      userKey,
      userRoleKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesByUserRoleKeyPatch(
    userKey: string,
    userRoleKey: string,
    request?: DeltaMapperUserRolePatchRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyRolesByUserRoleKeyPatch(
      userKey,
      userRoleKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesByUserRoleKeyPut(
    userKey: string,
    userRoleKey: string,
    request?: UserRoleEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyRolesByUserRoleKeyPut(
      userKey,
      userRoleKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesGet(
    userKey: string,
    headers?: Headers
  ): Promise<Array<UserRole>> {
    const response = await apiNskV1UsersByUserKeyRolesGet(
      userKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UsersByUserKeyRolesPost(
    userKey: string,
    request?: UserRoleCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersByUserKeyRolesPost(
      userKey,
      request,
      "body",
      headers
   ...
   */
  public async store_apiNskV1UsersPost(
    request?: UserCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UsersPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyPatch(
    userKey: string,
    personTravelDocumentKey: string,
    request?: DeltaMapperTravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyPatch(
      userKey,
      personTravelDocumentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV2UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyPut(
    userKey: string,
    personTravelDocumentKey: string,
    request?: TravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2UsersByUserKeyPersonTravelDocumentsByPersonTravelDocumentKeyPut(
      userKey,
      personTravelDocumentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV2UsersGet(
    ...
    const response = await apiNskV2UsersGet(
      organizationCode,
      locationGroupCode,
      domainCode,
      username,
   ...
   */
  public async store_apiNskV2UsersPost(
    request?: UserCreateRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2UsersPost(
      request,
      "body",
      headers
    ).toPromise();
