...
export class StoreAccountService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("AccountService") protected baseService:AccountService) {}
    ...
    {
        const response = await this.baseService.apiNskV1AccountPasswordChangePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AccountPasswordResetPost(request,'body', headers).toPromise();
