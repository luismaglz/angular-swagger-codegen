...
export class StoreVoucherIssuanceService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("VoucherIssuanceService") protected baseService:VoucherIssuanceService) {}
    ...
    {
        const response = await this.baseService.apiNskV1VoucherIssuanceByVoucherIssuanceKeyGet(voucherIssuanceKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VoucherIssuancePost(request,'body', headers).toPromise();
