...
export class StoreBookingcontactsService {
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodeDelete(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodeDelete(
      contactTypeCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodeGet(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodeGet(
      contactTypeCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePatch(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePatch(
      contactTypeCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeDelete(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeDelete(
      contactTypeCode,
      phoneNumberType,
      "body",
      headers
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeGet(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeGet(
      contactTypeCode,
      phoneNumberType,
      "body",
      headers
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypePut(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypePut(
      contactTypeCode,
      phoneNumberType,
      request,
      "body",
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePhoneNumbersGet(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePhoneNumbersGet(
      contactTypeCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePhoneNumbersPost(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePhoneNumbersPost(
      contactTypeCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingContactsByContactTypeCodePut(
    ...
    const response = await apiNskV1BookingContactsByContactTypeCodePut(
      contactTypeCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingContactsGet(
    ...
    const response = await apiNskV1BookingContactsGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPost(
    ...
    const response = await apiNskV1BookingContactsPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPrimaryDelete(
    ...
    const response = await apiNskV1BookingContactsPrimaryDelete(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPrimaryGet(
    ...
    const response = await apiNskV1BookingContactsPrimaryGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPrimaryPatch(
    ...
    const response = await apiNskV1BookingContactsPrimaryPatch(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPrimaryPost(
    ...
    const response = await apiNskV1BookingContactsPrimaryPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingContactsPrimaryPut(
    ...
    const response = await apiNskV1BookingContactsPrimaryPut(
      request,
      "body",
      headers
    ).toPromise();
