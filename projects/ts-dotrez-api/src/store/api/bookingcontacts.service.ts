...
export class StoreBookingcontactsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BookingcontactsService") protected baseService:BookingcontactsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodeDelete(contactTypeCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodeGet(contactTypeCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePatch(contactTypeCode,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeDelete(contactTypeCode,phoneNumberType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypeGet(contactTypeCode,phoneNumberType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePhoneNumbersByPhoneNumberTypePut(contactTypeCode,phoneNumberType,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePhoneNumbersGet(contactTypeCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePhoneNumbersPost(contactTypeCode,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsByContactTypeCodePut(contactTypeCode,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPrimaryDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPrimaryGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPrimaryPatch(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPrimaryPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingContactsPrimaryPut(request,'body', headers).toPromise();
