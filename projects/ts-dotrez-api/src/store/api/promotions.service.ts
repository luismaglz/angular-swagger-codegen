...
export class StorePromotionsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("PromotionsService") protected baseService:PromotionsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1PromotionsByPromotionCodeGet(promotionCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PromotionsByPromotionCodeValidateGet(promotionCode,organizationCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PromotionsGet(promotionCode,organizationCode,effectiveDate,cultureCode,promotionCodeMatching,organizationCodeMatching,'body', headers).toPromise();
