...
export class StorePromotionsService {
  ...
  public async store_apiNskV1PromotionsByPromotionCodeGet(
    ...
    const response = await apiNskV1PromotionsByPromotionCodeGet(
      promotionCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1PromotionsByPromotionCodeValidateGet(
    ...
    const response = await apiNskV1PromotionsByPromotionCodeValidateGet(
      promotionCode,
      organizationCode,
      "body",
      headers
  ...
  public async store_apiNskV1PromotionsGet(
    ...
    const response = await apiNskV1PromotionsGet(
      promotionCode,
      organizationCode,
      effectiveDate,
      cultureCode,
