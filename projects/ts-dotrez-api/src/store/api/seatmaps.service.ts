...
export class StoreSeatmapsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("SeatmapsService") protected baseService:SeatmapsService) {}
    ...
    {
        const response = await this.baseService.apiNskV3SeatmapsByJourneyKeyGet(journeyKey,includePropertyLookup,cultureCode,'body', headers).toPromise();
