...
export class StoreApoService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("ApoService") protected baseService:ApoService) {}
    ...
    {
        const response = await this.baseService.apiNskV1ApoByInputParameterKeyDelete(inputParameterKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ApoByInputParameterKeyPut(inputParameterKey,inputParameterValue,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ApoDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ApoGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ApoPost(inputParameters,'body', headers).toPromise();
