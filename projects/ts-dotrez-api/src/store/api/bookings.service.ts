...
export class StoreBookingsService {
  ...
  public async store_apiNskV1BookingsByBookingKeyHistoryFlightMoveGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistoryFlightMoveGet(
      bookingKey,
      lastPageKey,
      pageSize,
      "body",
  ...
  public async store_apiNskV1BookingsByBookingKeyHistoryGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistoryGet(
      bookingKey,
      event,
      lastPageKey,
      pageSize,
  ...
  public async store_apiNskV1BookingsByBookingKeyHistoryMessageGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistoryMessageGet(
      bookingKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingsByBookingKeyHistoryNotificationGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistoryNotificationGet(
      bookingKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingsByBookingKeyHistorySeatAssignmentGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistorySeatAssignmentGet(
      bookingKey,
      event,
      lastPageKey,
      pageSize,
  ...
  public async store_apiNskV1BookingsByBookingKeyHistorySegmentChangeGet(
    ...
    const response = await apiNskV1BookingsByBookingKeyHistorySegmentChangeGet(
      bookingKey,
      event,
      lastPageKey,
      pageSize,
  ...
  public async store_apiNskV1BookingsByBookingKeyQueueDelete(
    ...
    const response = await apiNskV1BookingsByBookingKeyQueueDelete(
      bookingKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByBookingKeyQueueHistoryPost(
    ...
    const response = await apiNskV1BookingsByBookingKeyQueueHistoryPost(
      bookingKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByBookingKeyQueuePost(
    ...
    const response = await apiNskV1BookingsByBookingKeyQueuePost(
      bookingKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountCollectionByAccountCollectionKeyTransactionsGet(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountCollectionByAccountCollectionKeyTransactionsGet(
      recordLocator,
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountCollectionByAccountCollectionKeyTransactionsPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountCollectionByAccountCollectionKeyTransactionsPost(
      recordLocator,
      accountCollectionKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountCollectionPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountCollectionPost(
      recordLocator,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountGet(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountGet(
      recordLocator,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountPost(
      recordLocator,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountStatusPut(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountStatusPut(
      recordLocator,
      status,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByRecordLocatorAccountTransactionsGet(
    ...
    const response = await apiNskV1BookingsByRecordLocatorAccountTransactionsGet(
      recordLocator,
      startTime,
      sortByNewest,
      endTime,
  ...
  public async store_apiNskV1BookingsByRecordLocatorCommentsPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorCommentsPost(
      recordLocator,
      comments,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsByRecordLocatorEmailPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorEmailPost(
      recordLocator,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingsByRecordLocatorFareOverrideJourneyByJourneyKeyPost(
    ...
    const response = await apiNskV1BookingsByRecordLocatorFareOverrideJourneyByJourneyKeyPost(
      recordLocator,
      journeyKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingsByRecordLocatorGet(
    ...
    const response = await apiNskV1BookingsByRecordLocatorGet(
      recordLocator,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyDelete(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyDelete(
      recordLocator,
      journeyKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyRequirementsGet(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyRequirementsGet(
      recordLocator,
      journeyKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyStatusGet(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorJourneyByJourneyKeyStatusGet(
      recordLocator,
      journeyKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyDelete(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyDelete(
      recordLocator,
      segmentKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyRequirementsGet(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyRequirementsGet(
      recordLocator,
      segmentKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyStatusGet(
    ...
    const response = await apiNskV1BookingsCheckinByRecordLocatorSegmentBySegmentKeyStatusGet(
      recordLocator,
      segmentKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingsSearchByAgencyGet(
    ...
    const response = await apiNskV1BookingsSearchByAgencyGet(
      organizationCode,
      firstName,
      lastName,
      phoneticSearch,
  ...
  public async store_apiNskV1BookingsSearchByAgentGet(
    ...
    const response = await apiNskV1BookingsSearchByAgentGet(
      agentId,
      firstName,
      lastName,
      phoneticSearch,
  ...
  public async store_apiNskV1BookingsSearchByBagTagGet(
    ...
    const response = await apiNskV1BookingsSearchByBagTagGet(
      bagTag,
      startUtc,
      endUtc,
      pageSize,
  ...
  public async store_apiNskV1BookingsSearchByContactCustomerNumberGet(
    ...
    const response = await apiNskV1BookingsSearchByContactCustomerNumberGet(
  ...
  public async store_apiNskV1BookingsSearchByContactGet(
    ...
    const response = await apiNskV1BookingsSearchByContactGet(
      firstName,
      lastName,
      recordLocator,
      phoneNumber,
  ...
  public async store_apiNskV1BookingsSearchByCustomerNumberGet(
    ...
    const response = await apiNskV1BookingsSearchByCustomerNumberGet(
      customerNumber,
      agentId,
      organizationCode,
      filtersPageSize,
  ...
  public async store_apiNskV1BookingsSearchByDateGet(
    ...
    const response = await apiNskV1BookingsSearchByDateGet(
      startDateUtc,
      endDateUtc,
      filtersPageSize,
      filtersLastIndex,
  ...
  public async store_apiNskV1BookingsSearchByEmailGet(
    ...
    const response = await apiNskV1BookingsSearchByEmailGet(
      emailAddress,
      agentId,
      phoneticSearch,
      filtersPageSize,
  ...
  public async store_apiNskV1BookingsSearchByLastNameGet(
    ...
    const response = await apiNskV1BookingsSearchByLastNameGet(
      lastName,
      firstName,
      phoneticSearch,
      filtersPageSize,
  ...
  public async store_apiNskV1BookingsSearchByPhoneGet(
    ...
    const response = await apiNskV1BookingsSearchByPhoneGet(
      phoneNumber,
      agentId,
      organizationCode,
      filtersPageSize,
  ...
  public async store_apiNskV1BookingsSearchByRecordLocatorGet(
    ...
    const response = await apiNskV1BookingsSearchByRecordLocatorGet(
      recordLocator,
      pageSize,
      lastIndex,
      sourceOrganization,
  ...
  public async store_apiNskV1BookingsSearchByThirdPartyRecordLocatorGet(
    ...
    const response = await apiNskV1BookingsSearchByThirdPartyRecordLocatorGet(
      systemCode,
      recordLocator,
      agentId,
      organizationCode,
  ...
  public async store_apiNskV2BookingsByRecordLocatorNotificationPost(
    ...
    const response = await apiNskV2BookingsByRecordLocatorNotificationPost(
      recordLocator,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingsGet(
    ...
    const response = await apiNskV2BookingsGet(
      recordLocator,
      emailAddress,
      origin,
      firstName,
  ...
  public async store_apiNskV2BookingsQuotePost(
    ...
    const response = await apiNskV2BookingsQuotePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV3BookingsCheckinByRecordLocatorJourneyByJourneyKeyPost(
    ...
    const response = await apiNskV3BookingsCheckinByRecordLocatorJourneyByJourneyKeyPost(
      recordLocator,
      journeyKey,
      request,
      "body",
  ...
  public async store_apiNskV3BookingsCheckinByRecordLocatorSegmentBySegmentKeyPost(
    ...
    const response = await apiNskV3BookingsCheckinByRecordLocatorSegmentBySegmentKeyPost(
      recordLocator,
      segmentKey,
      request,
      "body",
