...
export class StoreAvailabilityService {
  ...
  public async store_apiNskV1AvailabilityLowfareBetaPost(
    ...
    const response = await apiNskV1AvailabilityLowfareBetaPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2AvailabilityLowfarePost(
    ...
    const response = await apiNskV2AvailabilityLowfarePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2AvailabilityLowfareSimplePost(
    ...
    const response = await apiNskV2AvailabilityLowfareSimplePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV4AvailabilitySearchPost(
    ...
    const response = await apiNskV4AvailabilitySearchPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV4AvailabilitySearchSimplePost(
    ...
    const response = await apiNskV4AvailabilitySearchSimplePost(
      request,
      "body",
      headers
    ).toPromise();
