...
export class StoreAvailabilityService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("AvailabilityService") protected baseService:AvailabilityService) {}
    ...
    {
        const response = await this.baseService.apiNskV1AvailabilityLowfareBetaPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2AvailabilityLowfarePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2AvailabilityLowfareSimplePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV4AvailabilitySearchPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV4AvailabilitySearchSimplePost(request,'body', headers).toPromise();
