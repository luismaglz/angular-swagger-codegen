...
@injectable()
export class Store_AvailabilityService {
     ...
     * 
     */
    public store_apiNskV1AvailabilityLowfareBetaPost(request?: LowFareCacheRequest,  headers?: Headers): Promise<LowFareCacheAvailability>
    {
     ...
     */
    public store_apiNskV2AvailabilityLowfarePost(request?: LowFareAvailabilityRequest,  headers?: Headers): Promise<LowFareAvailability>
    {
     ...
     * Although this endpoint behaves like a GET, POST reduces the limitations resulting from URL length issues.
     */
    public store_apiNskV2AvailabilityLowfareSimplePost(request?: LowFareAvailabilitySearchSimpleRequest,  headers?: Headers): Promise<LowFareAvailability>
    {
     ...
     */
    public store_apiNskV4AvailabilitySearchPost(request?: AvailabilityRequestv2,  headers?: Headers): Promise<Availabilityv2>
    {
     ...
     */
    public store_apiNskV4AvailabilitySearchSimplePost(request?: AvailabilitySimpleRequestv2,  headers?: Headers): Promise<Availabilityv2>
    {
