...
export class StoreBundlesService {
  ...
  public async store_apiNskV1BundlesApplicationsByBundleApplicationKeyDetailsGet(
    ...
    const response = await apiNskV1BundlesApplicationsByBundleApplicationKeyDetailsGet(
  ...
  public async store_apiNskV1BundlesRulesByBundleRuleCodeDetailsGet(
    ...
    const response = await apiNskV1BundlesRulesByBundleRuleCodeDetailsGet(
      bundleRuleCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BundlesSetsByBundleSetCodeDetailsGet(
    ...
    const response = await apiNskV1BundlesSetsByBundleSetCodeDetailsGet(
      bundleSetCode,
      "body",
      headers
    ).toPromise();
