...
export class StoreBundlesService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BundlesService") protected baseService:BundlesService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BundlesApplicationsByBundleApplicationKeyDetailsGet(bundleApplicationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BundlesRulesByBundleRuleCodeDetailsGet(bundleRuleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BundlesSetsByBundleSetCodeDetailsGet(bundleSetCode,'body', headers).toPromise();
