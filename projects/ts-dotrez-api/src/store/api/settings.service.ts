...
export class StoreSettingsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("SettingsService") protected baseService:SettingsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingCheckinGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingContactGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingCustomerAccountGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingFeeGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingFlightSearchGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingPassengerGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsBookingReserveFlightsGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsGeneralApplicationLogonGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsGeneralCodesGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsGeneralSessionGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsItineraryGet(eTag,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsPaymentGet(eTag,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsUserAgencyCreationGet(eTag,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1SettingsUserCustomerCreationGet(eTag,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2SettingsBookingPaymentGet(eTag,roleCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2SettingsPremiumServicesGet(eTag,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2SettingsSkySpeedGet(eTag,roleCode,'body', headers).toPromise();
