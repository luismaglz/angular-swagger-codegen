...
export class StoreSettingsService {
  ...
  public async store_apiNskV1SettingsBookingCheckinGet(
    ...
    const response = await apiNskV1SettingsBookingCheckinGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingContactGet(
    ...
    const response = await apiNskV1SettingsBookingContactGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingCustomerAccountGet(
    ...
    const response = await apiNskV1SettingsBookingCustomerAccountGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingFeeGet(
    ...
    const response = await apiNskV1SettingsBookingFeeGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingFlightSearchGet(
    ...
    const response = await apiNskV1SettingsBookingFlightSearchGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingGet(
    ...
    const response = await apiNskV1SettingsBookingGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingPassengerGet(
    ...
    const response = await apiNskV1SettingsBookingPassengerGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsBookingReserveFlightsGet(
    ...
    const response = await apiNskV1SettingsBookingReserveFlightsGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsGeneralApplicationLogonGet(
    ...
    const response = await apiNskV1SettingsGeneralApplicationLogonGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsGeneralCodesGet(
    ...
    const response = await apiNskV1SettingsGeneralCodesGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsGeneralSessionGet(
    ...
    const response = await apiNskV1SettingsGeneralSessionGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV1SettingsItineraryGet(
    ...
    const response = await apiNskV1SettingsItineraryGet(
      eTag,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1SettingsPaymentGet(
    ...
    const response = await apiNskV1SettingsPaymentGet(
      eTag,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1SettingsUserAgencyCreationGet(
    ...
    const response = await apiNskV1SettingsUserAgencyCreationGet(
      eTag,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1SettingsUserCustomerCreationGet(
    ...
    const response = await apiNskV1SettingsUserCustomerCreationGet(
      eTag,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2SettingsBookingPaymentGet(
    ...
    const response = await apiNskV2SettingsBookingPaymentGet(
      eTag,
      roleCode,
      "body",
      headers
  ...
  public async store_apiNskV2SettingsPremiumServicesGet(
    ...
    const response = await apiNskV2SettingsPremiumServicesGet(
      eTag,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2SettingsSkySpeedGet(
    ...
    const response = await apiNskV2SettingsSkySpeedGet(
      eTag,
      roleCode,
      "body",
      headers
