...
export class StoreOrganizations2Service {
   ...
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountChildAccountTransactionsPost(
    organizationCode: string,
    request?: ChildAccountTransactionsRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountChildAccountTransactionsPost(
      organizationCode,
      request,
      "body",
      headers
   ...
   * The known list of parent-child relations are as follows:  - Dependent accounts are not supported.  - A parent&#39;s account of type credit may have children of type supplemental or credit.  - A parent&#39;s account of type prepaid may have children of type prepaid.  - No other combination of parent-child relations are supported.
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountChildAccountTransactionsPut(
    organizationCode: string,
    request?: ChildAccountTransactionsRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountChildAccountTransactionsPut(
      organizationCode,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountGet(
    organizationCode: string,
    headers?: Headers
  ): Promise<OrganizationAccount> {
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountGet(
      organizationCode,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountPost(
    organizationCode: string,
    request?: CreateOrganizationAccountRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountPost(
      organizationCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountStatusPut(
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountStatusPut(
      organizationCode,
      status,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountTransactionsGet(
    organizationCode: string,
    startTime: Date,
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountTransactionsGet(
      organizationCode,
      startTime,
      sortByNewest,
      endTime,
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeAccountTransactionsPost(
    organizationCode: string,
    request?: OrganizationTransactionRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeAccountTransactionsPost(
      organizationCode,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeDelete(
    organizationCode: string,
    commissionRateCode: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeDelete(
      organizationCode,
      commissionRateCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeGet(
    organizationCode: string,
    commissionRateCode: string,
    headers?: Headers
  ): Promise<OrganizationCommissionRate> {
    const response = await apiNskV1Organizations2ByOrganizationCodeCommissionRatesByCommissionRateCodeGet(
      organizationCode,
      commissionRateCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeCommissionRatesPost(
    organizationCode: string,
    request?: OrganizationCommissionRate,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeCommissionRatesPost(
      organizationCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersByPhoneNumberTypeDelete(
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersByPhoneNumberTypeDelete(
      organizationCode,
      phoneNumberType,
      "body",
      headers
  ...
  public async store_apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersByPhoneNumberTypePut(
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersByPhoneNumberTypePut(
      organizationCode,
      phoneNumberType,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersPost(
    organizationCode: string,
    request?: PhoneNumber,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeCompanyPhoneNumbersPost(
      organizationCode,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersByPhoneNumberTypeDelete(
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersByPhoneNumberTypeDelete(
      organizationCode,
      phoneNumberType,
      "body",
      headers
  ...
  public async store_apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersByPhoneNumberTypePut(
    ...
    const response = await apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersByPhoneNumberTypePut(
      organizationCode,
      phoneNumberType,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersPost(
    organizationCode: string,
    request?: PhoneNumber,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeContactPhoneNumbersPost(
      organizationCode,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyDelete(
    organizationCode: string,
    externalAccountKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyDelete(
      organizationCode,
      externalAccountKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyGet(
    organizationCode: string,
    externalAccountKey: string,
    headers?: Headers
  ): Promise<OrganizationExternalAccountv2> {
    const response = await apiNskV1Organizations2ByOrganizationCodeExternalAccountsByExternalAccountKeyGet(
      organizationCode,
      externalAccountKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeExternalAccountsPost(
    organizationCode: string,
    request?: OrganizationExternalAccountRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1Organizations2ByOrganizationCodeExternalAccountsPost(
      organizationCode,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1Organizations2ByOrganizationCodeGet(
    organizationCode: string,
    headers?: Headers
  ): Promise<Organizationv2> {
    const response = await apiNskV1Organizations2ByOrganizationCodeGet(
      organizationCode,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1Organizations2ByOrganizationCodePatch(
    organizationCode: string,
    createRequest?: DeltaMapperOrganizationEditRequest,
    headers?: Headers
  ): Promise<Organizationv2> {
    const response = await apiNskV1Organizations2ByOrganizationCodePatch(
      organizationCode,
      createRequest,
      "body",
      headers
   ...
   * Requires agent permissions.  The organization code is a generic code for all of the organization types. Each individual type has its own code  and validation.  If the organization status is not pending the organization code should follow these validation rules based on type:  &lt;ul&gt;&lt;li&gt;Third Party: 3 to 10 characters in length with alphanumeric values.&lt;/li&gt;&lt;li&gt;Travel Agency: 7 to 10 characters in length with numeric values.&lt;/li&gt;&lt;li&gt;Carrier: 2 to 3 characters in length with alphanumeric values.&lt;/li&gt;&lt;/ul&gt;
   */
  public async store_apiNskV1Organizations2ByOrganizationCodePut(
    organizationCode: string,
    request?: OrganizationEditRequest,
    headers?: Headers
  ): Promise<Organizationv2> {
    const response = await apiNskV1Organizations2ByOrganizationCodePut(
      organizationCode,
      request,
      "body",
      headers
   ...
   * Requires agent permissions.  The organization code is a generic code for all of the organization types. Each individual type has its own code  and validation.  If the organization status is not pending the organization code should follow these validation rules based on type:  &lt;ul&gt;&lt;li&gt;Third Party: 3 to 10 characters in length with alphanumeric values.&lt;/li&gt;&lt;li&gt;Travel Agency: 7 to 10 characters in length with numeric values.&lt;/li&gt;&lt;li&gt;Carrier: 2 to 3 characters in length with alphanumeric values.&lt;/li&gt;&lt;/ul&gt;
   */
  public async store_apiNskV1Organizations2Post(
    createRequest?: OrganizationCreateRequest,
    headers?: Headers
  ): Promise<Organizationv2> {
    const response = await apiNskV1Organizations2Post(
      createRequest,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1Organizations2RegisterPost(
    registerRequest?: OrganizationRegisterRequest,
    headers?: Headers
  ): Promise<Organizationv2> {
    const response = await apiNskV1Organizations2RegisterPost(
      registerRequest,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2Organizations2Get(
    ...
    const response = await apiNskV2Organizations2Get(
      type,
      status,
      organizationCode,
