...
export class StoreGraphService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("GraphService") protected baseService:GraphService) {}
    ...
    {
        const response = await this.baseService.apiNskV1GraphByQueryNamePost(queryName,cachedResults,variables,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1GraphPost(query,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV2GraphByQueryNamePost(queryName,query,'body', headers).toPromise();
