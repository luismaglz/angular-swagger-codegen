...
export class StoreOneTimeTravelNotificationsService {
   ...
   *
   */
  public async store_apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyDelete(
    oneTimeTravelNotificationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyDelete(
   ...
   *
   */
  public async store_apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyGet(
    oneTimeTravelNotificationKey: string,
    headers?: Headers
  ): Promise<OneTimeTravelNotification> {
    const response = await apiNskV1OneTimeTravelNotificationsByOneTimeTravelNotificationKeyGet(
      oneTimeTravelNotificationKey,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1OneTimeTravelNotificationsPost(
    request?: OneTimeNotificationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1OneTimeTravelNotificationsPost(
      request,
      "body",
      headers
    ).toPromise();
