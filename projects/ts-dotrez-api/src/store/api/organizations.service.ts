...
export class StoreOrganizationsService {
   ...
   *
   */
  public async store_apiNskV1OrganizationsGroupsByOrganizationGroupCodeGet(
    organizationGroupCode: string,
    headers?: Headers
  ): Promise<OrganizationGroupDetails> {
    const response = await apiNskV1OrganizationsGroupsByOrganizationGroupCodeGet(
   ...
   *
   */
  public async store_apiNskV1OrganizationsGroupsGet(
    headers?: Headers
  ): Promise<Array<OrganizationGroup>> {
    const response = await apiNskV1OrganizationsGroupsGet(
      "body",
      headers
    ).toPromise();
