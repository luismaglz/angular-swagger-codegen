...
import {
  apiNskV1UserBookingsByPassengerGet,
  apiNskV1UserBookingsGet,
  apiNskV1UserGet,
  apiNskV1UserImpersonateDelete,
  apiNskV1UserImpersonateGet,
  apiNskV1UserImpersonatePost,
  apiNskV1UserPasswordChangePost,
  apiNskV1UserPatch,
  apiNskV1UserPost,
  apiNskV1UserPut,
  apiNskV1UserRolesByUserRoleKeyDelete,
  apiNskV1UserRolesByUserRoleKeyGet,
  apiNskV1UserRolesByUserRoleKeyPatch,
  apiNskV1UserRolesByUserRoleKeyPut,
  apiNskV1UserRolesGet,
  apiNskV1UserRolesPost,
...
export class StoreUserService {
  ...
  public async store_apiNskV1UserBookingsByPassengerGet(
    ...
    const response = await apiNskV1UserBookingsByPassengerGet(
      startDate,
      endDate,
      "body",
      headers
  ...
  public async store_apiNskV1UserBookingsGet(
    ...
    const response = await apiNskV1UserBookingsGet(
      returnCount,
      associatedFirstName,
      associatedLastName,
      phoneticSearch,
  ...
  public async store_apiNskV1UserImpersonateDelete(
    ...
    const response = await apiNskV1UserImpersonateDelete(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserImpersonateGet(
    ...
    const response = await apiNskV1UserImpersonateGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserImpersonatePost(
    ...
    const response = await apiNskV1UserImpersonatePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserPasswordChangePost(
    ...
    const response = await apiNskV1UserPasswordChangePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserPatch(
    ...
    const response = await apiNskV1UserPatch(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserPost(
    ...
    const response = await apiNskV1UserPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserPut(
    ...
    const response = await apiNskV1UserPut(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserRolesByUserRoleKeyDelete(
    ...
    const response = await apiNskV1UserRolesByUserRoleKeyDelete(
      userRoleKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserRolesByUserRoleKeyGet(
    ...
    const response = await apiNskV1UserRolesByUserRoleKeyGet(
      userRoleKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserRolesByUserRoleKeyPatch(
    ...
    const response = await apiNskV1UserRolesByUserRoleKeyPatch(
      userRoleKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1UserRolesByUserRoleKeyPut(
    ...
    const response = await apiNskV1UserRolesByUserRoleKeyPut(
      userRoleKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1UserRolesPost(
    ...
    const response = await apiNskV1UserRolesPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserSingleSignOnTokenByProviderKeyDelete(
    ...
    const response = await apiNskV1UserSingleSignOnTokenByProviderKeyDelete(
      providerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserSingleSignOnTokenByProviderKeyGet(
    ...
    const response = await apiNskV1UserSingleSignOnTokenByProviderKeyGet(
      providerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1UserSingleSignOnTokenByProviderKeyPatch(
    ...
    const response = await apiNskV1UserSingleSignOnTokenByProviderKeyPatch(
      providerKey,
      tokenRequest,
      "body",
      headers
  ...
  public async store_apiNskV1UserSingleSignOnTokenByProviderKeyPost(
    ...
    const response = await apiNskV1UserSingleSignOnTokenByProviderKeyPost(
      providerKey,
      tokenRequest,
      "body",
      headers
  ...
  public async store_apiNskV1UserSingleSignOnTokenByProviderKeyPut(
    ...
    const response = await apiNskV1UserSingleSignOnTokenByProviderKeyPut(
      providerKey,
      tokenRequest,
      "body",
      headers
  ...
  public async store_apiNskV1UserSingleSignOnTokenGet(
    ...
    const response = await apiNskV1UserSingleSignOnTokenGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2UserPost(
    ...
    const response = await apiNskV2UserPost(
      request,
      "body",
      headers
    ).toPromise();
