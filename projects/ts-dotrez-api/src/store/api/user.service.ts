...
export class StoreUserService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("UserService") protected baseService:UserService) {}
    ...
    {
        const response = await this.baseService.apiNskV1UserBookingsByPassengerGet(startDate,endDate,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserBookingsGet(returnCount,associatedFirstName,associatedLastName,phoneticSearch,tripIdentifier,origin,destination,searchArchive,tripDate,startDate,endDate,searchByCustomerNumber,lastBookingKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserImpersonateDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserImpersonateGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserImpersonatePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserPasswordChangePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserPatch(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserPut(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesByUserRoleKeyDelete(userRoleKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesByUserRoleKeyGet(userRoleKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesByUserRoleKeyPatch(userRoleKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesByUserRoleKeyPut(userRoleKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserRolesPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenByProviderKeyDelete(providerKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenByProviderKeyGet(providerKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenByProviderKeyPatch(providerKey,tokenRequest,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenByProviderKeyPost(providerKey,tokenRequest,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenByProviderKeyPut(providerKey,tokenRequest,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1UserSingleSignOnTokenGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2UserPost(request,'body', headers).toPromise();
