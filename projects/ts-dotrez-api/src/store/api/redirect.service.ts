...
export class StoreRedirectService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("RedirectService") protected baseService:RedirectService) {}
    ...
    {
        const response = await this.baseService.apiV1RedirectGet(domain,scheme,port,path,param1,value1,param2,value2,param3,value3,param4,value4,'body', headers).toPromise();
