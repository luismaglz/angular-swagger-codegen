...
export class StoreCollectionService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("CollectionService") protected baseService:CollectionService) {}
    ...
    {
        const response = await this.baseService.apiNskV1CollectionByAccountCollectionKeyTransactionsGet(accountCollectionKey,startTime,sortByNewest,endTime,pageSize,pageIndex,'body', headers).toPromise();
