...
export class StoreQueuesService {
  ...
  public async store_apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyDelete(
    ...
    const response = await apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyDelete(
      bookingQueueCode,
      bookingQueueItemKey,
      request,
      "body",
  ...
  public async store_apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyPut(
    ...
    const response = await apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyPut(
      bookingQueueCode,
      bookingQueueItemKey,
      request,
      "body",
  ...
  public async store_apiNskV1QueuesTravelByTravelQueueCodeNextGet(
    ...
    const response = await apiNskV1QueuesTravelByTravelQueueCodeNextGet(
      travelQueueCode,
      subQueueCode,
      "body",
      headers
  ...
  public async store_apiNskV1QueuesTravelPost(
    ...
    const response = await apiNskV1QueuesTravelPost(
      item,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2QueuesBookingsByBookingQueueCodeNextGet(
    ...
    const response = await apiNskV2QueuesBookingsByBookingQueueCodeNextGet(
      bookingQueueCode,
      subQueueCode,
      startDate,
      endDate,
  ...
  public async store_apiNskV2QueuesBookingsGet(
    ...
    const response = await apiNskV2QueuesBookingsGet(
      queueName,
      queueCode,
      queueCategoryCode,
      pageSize,
