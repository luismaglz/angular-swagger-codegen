...
export class StoreQueuesService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("QueuesService") protected baseService:QueuesService) {}
    ...
    {
        const response = await this.baseService.apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyDelete(bookingQueueCode,bookingQueueItemKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1QueuesBookingsByBookingQueueCodeItemsByBookingQueueItemKeyPut(bookingQueueCode,bookingQueueItemKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1QueuesTravelByTravelQueueCodeNextGet(travelQueueCode,subQueueCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1QueuesTravelPost(item,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2QueuesBookingsByBookingQueueCodeNextGet(bookingQueueCode,subQueueCode,startDate,endDate,password,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2QueuesBookingsGet(queueName,queueCode,queueCategoryCode,pageSize,lastPageIndex,'body', headers).toPromise();
