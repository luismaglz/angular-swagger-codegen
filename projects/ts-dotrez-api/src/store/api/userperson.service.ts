...
export class StoreUserpersonService {
   ...
   *
   */
  public async store_apiNskV1UserPersonAccountCollectionByAccountCollectionKeyTransactionsGet(
    ...
    const response = await apiNskV1UserPersonAccountCollectionByAccountCollectionKeyTransactionsGet(
   ...
   *
   */
  public async store_apiNskV1UserPersonAccountGet(
    headers?: Headers
  ): Promise<Account> {
    const response = await apiNskV1UserPersonAccountGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAccountTransactionsGet(
    startTime: Date,
    sortByNewest: boolean,
    endTime?: Date,
    pageSize?: number,
    ...
    const response = await apiNskV1UserPersonAccountTransactionsGet(
      startTime,
      sortByNewest,
      endTime,
      pageSize,
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesByPersonAddressKeyDelete(
    personAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAddressesByPersonAddressKeyDelete(
      personAddressKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesByPersonAddressKeyGet(
    personAddressKey: string,
    headers?: Headers
  ): Promise<PersonAddress> {
    const response = await apiNskV1UserPersonAddressesByPersonAddressKeyGet(
      personAddressKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesByPersonAddressKeyPatch(
    personAddressKey: string,
    request?: DeltaMapperPersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAddressesByPersonAddressKeyPatch(
      personAddressKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesByPersonAddressKeyPut(
    personAddressKey: string,
    request?: PersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAddressesByPersonAddressKeyPut(
      personAddressKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesGet(
    headers?: Headers
  ): Promise<Array<PersonAddress>> {
    const response = await apiNskV1UserPersonAddressesGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAddressesPost(
    request?: PersonAddressCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAddressesPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesByPersonAliasKeyDelete(
    personAliasKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAliasesByPersonAliasKeyDelete(
      personAliasKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesByPersonAliasKeyGet(
    personAliasKey: string,
    headers?: Headers
  ): Promise<PersonAlias> {
    const response = await apiNskV1UserPersonAliasesByPersonAliasKeyGet(
      personAliasKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesByPersonAliasKeyPatch(
    personAliasKey: string,
    request?: DeltaMapperPersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAliasesByPersonAliasKeyPatch(
      personAliasKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesByPersonAliasKeyPut(
    personAliasKey: string,
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAliasesByPersonAliasKeyPut(
      personAliasKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesGet(
    headers?: Headers
  ): Promise<Array<PersonAlias>> {
    const response = await apiNskV1UserPersonAliasesGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonAliasesPost(
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonAliasesPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsByPersonCommentKeyDelete(
    personCommentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonCommentsByPersonCommentKeyDelete(
      personCommentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsByPersonCommentKeyGet(
    personCommentKey: string,
    headers?: Headers
  ): Promise<PersonComment> {
    const response = await apiNskV1UserPersonCommentsByPersonCommentKeyGet(
      personCommentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsByPersonCommentKeyPatch(
    personCommentKey: string,
    request?: DeltaMapperPersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonCommentsByPersonCommentKeyPatch(
      personCommentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsByPersonCommentKeyPut(
    personCommentKey: string,
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonCommentsByPersonCommentKeyPut(
      personCommentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsGet(
    headers?: Headers
  ): Promise<Array<PersonComment>> {
    const response = await apiNskV1UserPersonCommentsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonCommentsPost(
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonCommentsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsByPersonEmailAddressKeyDelete(
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonEmailsByPersonEmailAddressKeyDelete(
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsByPersonEmailAddressKeyGet(
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<PersonEmail> {
    const response = await apiNskV1UserPersonEmailsByPersonEmailAddressKeyGet(
      personEmailAddressKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsByPersonEmailAddressKeyPatch(
    personEmailAddressKey: string,
    request?: DeltaMapperPersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonEmailsByPersonEmailAddressKeyPatch(
      personEmailAddressKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsByPersonEmailAddressKeyPut(
    personEmailAddressKey: string,
    request?: PersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonEmailsByPersonEmailAddressKeyPut(
      personEmailAddressKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsGet(
    headers?: Headers
  ): Promise<Array<PersonEmail>> {
    const response = await apiNskV1UserPersonEmailsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonEmailsPost(
    request?: PersonEmailCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonEmailsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationByPersonInformationKeyDelete(
    personInformationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonInformationByPersonInformationKeyDelete(
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationByPersonInformationKeyGet(
    personInformationKey: string,
    headers?: Headers
  ): Promise<PersonInformation> {
    const response = await apiNskV1UserPersonInformationByPersonInformationKeyGet(
      personInformationKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationByPersonInformationKeyPatch(
    personInformationKey: string,
    request?: DeltaMapperPersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonInformationByPersonInformationKeyPatch(
      personInformationKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationByPersonInformationKeyPut(
    personInformationKey: string,
    request?: PersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonInformationByPersonInformationKeyPut(
      personInformationKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationGet(
    headers?: Headers
  ): Promise<Array<PersonInformation>> {
    const response = await apiNskV1UserPersonInformationGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonInformationPost(
    request?: PersonInformationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonInformationPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPatch(
    request?: DeltaMapperPersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPatch(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyDelete(
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyDelete(
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyGet(
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<PersonPhoneNumber> {
    const response = await apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyGet(
      personPhoneNumberKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyPatch(
    personPhoneNumberKey: string,
    request?: DeltaMapperPersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyPatch(
      personPhoneNumberKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyPut(
    personPhoneNumberKey: string,
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPhoneNumbersByPersonPhoneNumberKeyPut(
      personPhoneNumberKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersGet(
    headers?: Headers
  ): Promise<Array<PersonPhoneNumber>> {
    const response = await apiNskV1UserPersonPhoneNumbersGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPhoneNumbersPost(
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPhoneNumbersPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesByPersonPreferenceKeyDelete(
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPreferencesByPersonPreferenceKeyDelete(
      personPreferenceKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesByPersonPreferenceKeyGet(
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<PersonPreference> {
    const response = await apiNskV1UserPersonPreferencesByPersonPreferenceKeyGet(
      personPreferenceKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesByPersonPreferenceKeyPatch(
    personPreferenceKey: string,
    request?: DeltaMapperPersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPreferencesByPersonPreferenceKeyPatch(
      personPreferenceKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesByPersonPreferenceKeyPut(
    personPreferenceKey: string,
    request?: PersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPreferencesByPersonPreferenceKeyPut(
      personPreferenceKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesGet(
    headers?: Headers
  ): Promise<Array<PersonPreference>> {
    const response = await apiNskV1UserPersonPreferencesGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPreferencesPost(
    request?: PersonPreferenceCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPreferencesPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsByPersonProgramKeyDelete(
    personProgramKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonProgramsByPersonProgramKeyDelete(
      personProgramKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsByPersonProgramKeyGet(
    personProgramKey: string,
    headers?: Headers
  ): Promise<PersonCustomerProgram> {
    const response = await apiNskV1UserPersonProgramsByPersonProgramKeyGet(
      personProgramKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsByPersonProgramKeyPatch(
    personProgramKey: string,
    request?: DeltaMapperPersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonProgramsByPersonProgramKeyPatch(
      personProgramKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsByPersonProgramKeyPut(
    personProgramKey: string,
    request?: PersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonProgramsByPersonProgramKeyPut(
      personProgramKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsGet(
    headers?: Headers
  ): Promise<Array<PersonCustomerProgram>> {
    const response = await apiNskV1UserPersonProgramsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonProgramsPost(
    request?: PersonCustomerProgramCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonProgramsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonPut(
    request?: PersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonPut(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyDelete(
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyDelete(
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyGet(
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<PersonStoredPayment> {
    const response = await apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyGet(
      personStoredPaymentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyPatch(
    personStoredPaymentKey: string,
    request?: DeltaMapperPersonStoredPaymentUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyPatch(
      personStoredPaymentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyPut(
    personStoredPaymentKey: string,
    request?: PersonStoredPaymentUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonStoredPaymentsByPersonStoredPaymentKeyPut(
      personStoredPaymentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsGet(
    headers?: Headers
  ): Promise<Array<PersonStoredPayment>> {
    const response = await apiNskV1UserPersonStoredPaymentsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonStoredPaymentsPost(
    request?: PersonStoredPaymentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonStoredPaymentsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelDocumentsByPersonTravelDocumentKeyDelete(
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelDocumentsByPersonTravelDocumentKeyDelete(
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelDocumentsByPersonTravelDocumentKeyGet(
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<PersonTravelDocument> {
    const response = await apiNskV1UserPersonTravelDocumentsByPersonTravelDocumentKeyGet(
      personTravelDocumentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelDocumentsGet(
    headers?: Headers
  ): Promise<Array<PersonTravelDocument>> {
    const response = await apiNskV1UserPersonTravelDocumentsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelDocumentsPost(
    request?: PersonTravelDocumentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelDocumentsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyDelete(
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyDelete(
  ...
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
    ...
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
      travelNotificationKey,
      eventType,
      "body",
      headers
  ...
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
    ...
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
      travelNotificationKey,
      eventType,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsGet(
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationEvent>> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsGet(
      travelNotificationKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsPost(
    travelNotificationKey: string,
    request?: NotificationEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyEventsPost(
      travelNotificationKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyGet(
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<TravelNotification> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyGet(
      travelNotificationKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyPatch(
    travelNotificationKey: string,
    request?: DeltaMapperTravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyPatch(
      travelNotificationKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyPut(
    travelNotificationKey: string,
    request?: TravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyPut(
      travelNotificationKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
    ...
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
      travelNotificationKey,
      timedEventType,
      "body",
      headers
  ...
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
    ...
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
      travelNotificationKey,
      timedEventType,
      "body",
      headers
  ...
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
    ...
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
      travelNotificationKey,
      timedEventType,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsGet(
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationTimedEvent>> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsGet(
      travelNotificationKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsPost(
    travelNotificationKey: string,
    request?: NotificationTimedEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsByTravelNotificationKeyTimedEventsPost(
      travelNotificationKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsGet(
    headers?: Headers
  ): Promise<Array<TravelNotification>> {
    const response = await apiNskV1UserPersonTravelNotificationsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1UserPersonTravelNotificationsPost(
    request?: TravelNotificationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1UserPersonTravelNotificationsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2UserPersonTravelDocumentsByPersonTravelDocumentKeyPatch(
    personTravelDocumentKey: string,
    request?: DeltaMapperTravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2UserPersonTravelDocumentsByPersonTravelDocumentKeyPatch(
      personTravelDocumentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV2UserPersonTravelDocumentsByPersonTravelDocumentKeyPut(
    personTravelDocumentKey: string,
    request?: TravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2UserPersonTravelDocumentsByPersonTravelDocumentKeyPut(
      personTravelDocumentKey,
      request,
      "body",
      headers
