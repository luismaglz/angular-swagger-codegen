...
export class StoreMessagesService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("MessagesService") protected baseService:MessagesService) {}
    ...
    {
        const response = await this.baseService.apiNskV1MessagesByMessageKeyDelete(messageKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1MessagesByMessageKeyGet(messageKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1MessagesGet(searchType,messageTypeCode,searchStartDate,searchEndDate,pageSize,lastIndex,searchValue,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1MessagesPost(request,'body', headers).toPromise();
