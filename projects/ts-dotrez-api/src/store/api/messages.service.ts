...
export class StoreMessagesService {
  ...
  public async store_apiNskV1MessagesByMessageKeyDelete(
    ...
    const response = await apiNskV1MessagesByMessageKeyDelete(
      messageKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1MessagesByMessageKeyGet(
    ...
    const response = await apiNskV1MessagesByMessageKeyGet(
      messageKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1MessagesGet(
    ...
    const response = await apiNskV1MessagesGet(
      searchType,
      messageTypeCode,
      searchStartDate,
      searchEndDate,
  ...
  public async store_apiNskV1MessagesPost(
    ...
    const response = await apiNskV1MessagesPost(
      request,
      "body",
      headers
    ).toPromise();
