...
export class StoreMessagesService {
    ...
    {
        const response = await apiNskV1MessagesByMessageKeyDelete(messageKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1MessagesByMessageKeyGet(messageKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1MessagesGet(searchType,messageTypeCode,searchStartDate,searchEndDate,pageSize,lastIndex,searchValue,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1MessagesPost(request,'body', headers).toPromise();
