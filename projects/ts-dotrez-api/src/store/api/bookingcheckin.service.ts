...
export class StoreBookingcheckinService {
   ...
   *
   */
  public async store_apiNskV1BookingCheckinJourneyByJourneyKeyDelete(
    journeyKey: string,
    request?: CheckinPassengersRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingCheckinJourneyByJourneyKeyDelete(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingCheckinJourneyByJourneyKeyRequirementsGet(
    journeyKey: string,
    headers?: Headers
  ): Promise<CheckinRequirements> {
    const response = await apiNskV1BookingCheckinJourneyByJourneyKeyRequirementsGet(
      journeyKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingCheckinJourneyByJourneyKeyStatusGet(
    journeyKey: string,
    headers?: Headers
  ): Promise<Array<CheckinPassengerLiftStatus>> {
    const response = await apiNskV1BookingCheckinJourneyByJourneyKeyStatusGet(
      journeyKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingCheckinSegmentBySegmentKeyDelete(
    segmentKey: string,
    request?: CheckinPassengersRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingCheckinSegmentBySegmentKeyDelete(
      segmentKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingCheckinSegmentBySegmentKeyRequirementsGet(
    segmentKey: string,
    headers?: Headers
  ): Promise<CheckinRequirements> {
    const response = await apiNskV1BookingCheckinSegmentBySegmentKeyRequirementsGet(
      segmentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingCheckinSegmentBySegmentKeyStatusGet(
    segmentKey: string,
    headers?: Headers
  ): Promise<InlineResponse2003> {
    const response = await apiNskV1BookingCheckinSegmentBySegmentKeyStatusGet(
      segmentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV3BookingCheckinJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: CheckinPassengersRequestv3,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV3BookingCheckinJourneyByJourneyKeyPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV3BookingCheckinSegmentBySegmentKeyPost(
    segmentKey: string,
    request?: CheckinPassengersRequestv3,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV3BookingCheckinSegmentBySegmentKeyPost(
      segmentKey,
      request,
      "body",
      headers
