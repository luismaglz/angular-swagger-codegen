...
export class StoreTripService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("TripService") protected baseService:TripService) {}
    ...
    {
        const response = await this.baseService.apiNskV1TripDowngradePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripFlyAheadAvailabilityByJourneyKeyGet(journeyKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripFlyAheadAvailabilityPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripInfoByLegKeyDetailsGet(legKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripInfoPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripInfoSimpleGet(beginDate,numberOfJourneys,origin,destination,endDate,startTimeInterval,endTimeInterval,identifier,carrierCode,flightType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripMoveAvailabilitySelfServiceGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripMovePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripScheduleGet(origin,destination,beginDate,endDate,type,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripUpgradeByUpgradeKeyPost(upgradeKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripUpgradeGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TripUpgradePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2TripInfoByLegKeyStatusGet(legKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2TripMoveAvailabilityByJourneyKeyGet(journeyKey,passengerMoveType,beginDate,origin,destination,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2TripMoveAvailabilityPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3TripRebookAvailabilityPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3TripRebookAvailabilitySimpleGet(origin,destination,beginDate,endDate,loyaltyFilter,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV4TripPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV4TripSellPost(request,'body', headers).toPromise();
