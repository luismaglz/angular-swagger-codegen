...
export class StoreAddOnsService {
  ...
  public async store_apiNskV1AddOnsActivitiesAvailablePost(
    ...
    const response = await apiNskV1AddOnsActivitiesAvailablePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsActivitiesPost(
    ...
    const response = await apiNskV1AddOnsActivitiesPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsActivitiesQuotePost(
    ...
    const response = await apiNskV1AddOnsActivitiesQuotePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsCarsAvailablePost(
    ...
    const response = await apiNskV1AddOnsCarsAvailablePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsCarsPost(
    ...
    const response = await apiNskV1AddOnsCarsPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsCarsQuotePost(
    ...
    const response = await apiNskV1AddOnsCarsQuotePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsHotelsAvailablePost(
    ...
    const response = await apiNskV1AddOnsHotelsAvailablePost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsHotelsPost(
    ...
    const response = await apiNskV1AddOnsHotelsPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1AddOnsHotelsQuotePost(
    ...
    const response = await apiNskV1AddOnsHotelsQuotePost(
      request,
      "body",
      headers
    ).toPromise();
