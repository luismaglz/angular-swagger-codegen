...
export class StoreAddOnsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("AddOnsService") protected baseService:AddOnsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsActivitiesAvailablePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsActivitiesPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsActivitiesQuotePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsCarsAvailablePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsCarsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsCarsQuotePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsHotelsAvailablePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsHotelsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1AddOnsHotelsQuotePost(request,'body', headers).toPromise();
