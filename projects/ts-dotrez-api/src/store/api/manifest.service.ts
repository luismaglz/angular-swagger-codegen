...
export class StoreManifestService {
  ...
  public async store_apiNskV1ManifestByLegKeyPassengerDetailsGet(
    ...
    const response = await apiNskV1ManifestByLegKeyPassengerDetailsGet(
      legKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1ManifestByLegKeyPassengerSeatAssignmentsGet(
    ...
    const response = await apiNskV1ManifestByLegKeyPassengerSeatAssignmentsGet(
      legKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1ManifestByLegKeyPost(
    ...
    const response = await apiNskV1ManifestByLegKeyPost(
      legKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1ManifestGet(
    ...
    const response = await apiNskV1ManifestGet(
      beginDate,
      origin,
      destination,
      identifier,
