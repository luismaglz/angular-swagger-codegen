...
export class StoreManifestService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("ManifestService") protected baseService:ManifestService) {}
    ...
    {
        const response = await this.baseService.apiNskV1ManifestByLegKeyPassengerDetailsGet(legKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ManifestByLegKeyPassengerSeatAssignmentsGet(legKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ManifestByLegKeyPost(legKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1ManifestGet(beginDate,origin,destination,identifier,carrierCode,flightType,'body', headers).toPromise();
