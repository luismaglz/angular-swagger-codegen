...
export class StoreBookingboardingpassesService {
   ...
   *
   */
  public async store_apiNskV1BookingBoardingpassesM2dJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassPassengerFilterRequest,
    headers?: Headers
  ): Promise<BoardingPassesM2D> {
    const response = await apiNskV1BookingBoardingpassesM2dJourneyByJourneyKeyPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingBoardingpassesS2dJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassPassengerFilterRequest,
    headers?: Headers
  ): Promise<BoardingPassesS2D> {
    const response = await apiNskV1BookingBoardingpassesS2dJourneyByJourneyKeyPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV3BookingBoardingpassesJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: BoardingPassFilterRequest,
    headers?: Headers
  ): Promise<BoardingPassesCollectionv2> {
    const response = await apiNskV3BookingBoardingpassesJourneyByJourneyKeyPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV3BookingBoardingpassesSegmentBySegmentKeyPost(
    segmentKey: string,
    request?: BoardingPassPassengerFilterRequest,
    headers?: Headers
  ): Promise<BoardingPassesCollectionv2> {
    const response = await apiNskV3BookingBoardingpassesSegmentBySegmentKeyPost(
      segmentKey,
      request,
      "body",
      headers
