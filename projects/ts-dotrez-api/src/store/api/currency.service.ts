...
export class StoreCurrencyService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("CurrencyService") protected baseService:CurrencyService) {}
    ...
    {
        const response = await this.baseService.apiNskV1CurrencyConverterGet(fromCurrencyCode,toCurrencyCode,amount,'body', headers).toPromise();
