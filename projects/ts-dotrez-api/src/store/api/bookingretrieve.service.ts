...
export class StoreBookingretrieveService {
  ...
  public async store_apiNskV1BookingRetrieveByBookingKeyGet(
    ...
    const response = await apiNskV1BookingRetrieveByBookingKeyGet(
      bookingKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingRetrieveByRecordLocatorByRecordLocatorGet(
    ...
    const response = await apiNskV1BookingRetrieveByRecordLocatorByRecordLocatorGet(
      recordLocator,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingRetrieveGet(
    ...
    const response = await apiNskV2BookingRetrieveGet(
      recordLocator,
      emailAddress,
      origin,
      firstName,
