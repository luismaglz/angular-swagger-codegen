...
export class StoreBookingretrieveService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BookingretrieveService") protected baseService:BookingretrieveService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BookingRetrieveByBookingKeyGet(bookingKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRetrieveByRecordLocatorByRecordLocatorGet(recordLocator,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingRetrieveGet(recordLocator,emailAddress,origin,firstName,lastName,customerNumber,departureDate,'body', headers).toPromise();
