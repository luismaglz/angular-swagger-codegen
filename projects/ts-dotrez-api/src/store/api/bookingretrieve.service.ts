...
@injectable()
export class Store_BookingretrieveService {
     ...
     */
    public store_apiNskV1BookingRetrieveByBookingKeyGet(bookingKey: string,  headers?: Headers): Promise<Booking>
    {
     ...
     * This action requires a session token and the user logged in.
     */
    public store_apiNskV1BookingRetrieveByRecordLocatorByRecordLocatorGet(recordLocator: string,  headers?: Headers): Promise<Booking>
    {
     ...
     */
    public store_apiNskV2BookingRetrieveGet(recordLocator: string, emailAddress?: string, origin?: string, firstName?: string, lastName?: string, customerNumber?: string, departureDate?: Date,  headers?: Headers): Promise<Booking>
    {
