...
export class StoreBookingssrsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BookingssrsService") protected baseService:BookingssrsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsBySsrKeyDelete(ssrKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsBySsrKeyGet(ssrKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsBySsrKeyPut(ssrKey,note,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsManualDelete(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsManualPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSsrsResellPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingSsrsAvailabilityPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingSsrsBySsrKeyPost(ssrKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingSsrsPost(request,'body', headers).toPromise();
