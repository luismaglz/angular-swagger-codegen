...
export class StoreBookingssrsService {
  ...
  public async store_apiNskV1BookingSsrsBySsrKeyDelete(
    ...
    const response = await apiNskV1BookingSsrsBySsrKeyDelete(
      ssrKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingSsrsBySsrKeyGet(
    ...
    const response = await apiNskV1BookingSsrsBySsrKeyGet(
      ssrKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingSsrsBySsrKeyPut(
    ...
    const response = await apiNskV1BookingSsrsBySsrKeyPut(
      ssrKey,
      note,
      "body",
      headers
  ...
  public async store_apiNskV1BookingSsrsManualDelete(
    ...
    const response = await apiNskV1BookingSsrsManualDelete(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingSsrsManualPost(
    ...
    const response = await apiNskV1BookingSsrsManualPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingSsrsResellPost(
    ...
    const response = await apiNskV1BookingSsrsResellPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingSsrsAvailabilityPost(
    ...
    const response = await apiNskV2BookingSsrsAvailabilityPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingSsrsBySsrKeyPost(
    ...
    const response = await apiNskV2BookingSsrsBySsrKeyPost(
      ssrKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV2BookingSsrsPost(
    ...
    const response = await apiNskV2BookingSsrsPost(
      request,
      "body",
      headers
    ).toPromise();
