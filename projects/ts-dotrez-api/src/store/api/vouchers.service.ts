...
export class StoreVouchersService {
  ...
  public async store_apiNskV1VouchersByDateGet(
    ...
    const response = await apiNskV1VouchersByDateGet(
      beginDate,
      pageSize,
      lastPageKey,
      endDate,
  ...
  public async store_apiNskV1VouchersByIssuanceByVoucherIssuanceKeyGet(
    ...
    const response = await apiNskV1VouchersByIssuanceByVoucherIssuanceKeyGet(
      voucherIssuanceKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1VouchersByMarketGet(
    ...
    const response = await apiNskV1VouchersByMarketGet(
      destination,
      origin,
      departureDate,
      identifier,
  ...
  public async store_apiNskV1VouchersByVoucherKeyGet(
    ...
    const response = await apiNskV1VouchersByVoucherKeyGet(
      voucherKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1VouchersByVoucherKeyPut(
    ...
    const response = await apiNskV1VouchersByVoucherKeyPut(
      voucherKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1VouchersConfigurationByConfigurationCodeGet(
    ...
    const response = await apiNskV1VouchersConfigurationByConfigurationCodeGet(
      configurationCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1VouchersConfigurationGet(
    ...
    const response = await apiNskV1VouchersConfigurationGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1VouchersGet(
    ...
    const response = await apiNskV1VouchersGet(
