...
export class StoreVouchersService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("VouchersService") protected baseService:VouchersService) {}
    ...
    {
        const response = await this.baseService.apiNskV1VouchersByDateGet(beginDate,pageSize,lastPageKey,endDate,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersByIssuanceByVoucherIssuanceKeyGet(voucherIssuanceKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersByMarketGet(destination,origin,departureDate,identifier,carrierCode,opSuffix,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersByVoucherKeyGet(voucherKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersByVoucherKeyPut(voucherKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersConfigurationByConfigurationCodeGet(configurationCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersConfigurationGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1VouchersGet(customerNameFirstName,customerNameLastName,activeOnly,recordLocator,customerNumber,cultureCode,'body', headers).toPromise();
