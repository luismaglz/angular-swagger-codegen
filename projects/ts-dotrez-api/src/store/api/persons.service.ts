...
export class StorePersonsService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("PersonsService") protected baseService:PersonsService) {}
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsGet(personKey,accountCollectionKey,startTime,sortByNewest,endTime,pageSize,pageIndex,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsPost(personKey,accountCollectionKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountCollectionPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountStatusPut(personKey,status,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAccountTransactionsGet(personKey,startTime,sortByNewest,endTime,pageSize,pageIndex,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyDelete(personKey,personAddressKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyGet(personKey,personAddressKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPatch(personKey,personAddressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPut(personKey,personAddressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAddressesPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyDelete(personKey,personAliasKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyGet(personKey,personAliasKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPatch(personKey,personAliasKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPut(personKey,personAliasKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyAliasesPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyDelete(personKey,personCommentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyGet(personKey,personCommentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPatch(personKey,personCommentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPut(personKey,personCommentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyCommentsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyDelete(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyDelete(personKey,personEmailAddressKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyGet(personKey,personEmailAddressKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPatch(personKey,personEmailAddressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPut(personKey,personEmailAddressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyEmailsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyDelete(personKey,personInformationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyGet(personKey,personInformationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPatch(personKey,personInformationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPut(personKey,personInformationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyInformationPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPatch(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyDelete(personKey,personPhoneNumberKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyGet(personKey,personPhoneNumberKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPatch(personKey,personPhoneNumberKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPut(personKey,personPhoneNumberKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPhoneNumbersPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyDelete(personKey,personPreferenceKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyGet(personKey,personPreferenceKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPatch(personKey,personPreferenceKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPut(personKey,personPreferenceKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPreferencesPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyDelete(personKey,personProgramKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyGet(personKey,personProgramKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPatch(personKey,personProgramKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPut(personKey,personProgramKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyProgramsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyPut(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyDelete(personKey,personStoredPaymentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyGet(personKey,personStoredPaymentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPatch(personKey,personStoredPaymentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPut(personKey,personStoredPaymentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyStoredPaymentsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyDelete(personKey,personTravelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyGet(personKey,personTravelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelDocumentsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelDocumentsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyDelete(personKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(personKey,travelNotificationKey,eventType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(personKey,travelNotificationKey,eventType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsGet(personKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsPost(personKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyGet(personKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPatch(personKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPut(personKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(personKey,travelNotificationKey,timedEventType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(personKey,travelNotificationKey,timedEventType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(personKey,travelNotificationKey,timedEventType,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(personKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(personKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsGet(personKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsByPersonKeyTravelNotificationsPost(personKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsGet(activeOnly,firstName,lastName,firstNameMatching,customerNumber,phoneNumber,emailAddress,programNumber,programCode,type,nationalIdNumber,nationalIdNumberMatching,returnCount,lastPersonKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1PersonsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPatch(personKey,personTravelDocumentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPut(personKey,personTravelDocumentKey,request,'body', headers).toPromise();
