...
export class StorePersonsService {
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsGet(
    personKey: string,
    ...
    const response = await apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsGet(
      personKey,
   ...
   */
  public async store_apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsPost(
    personKey: string,
    accountCollectionKey: string,
    request?: TransactionRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAccountCollectionByAccountCollectionKeyTransactionsPost(
      personKey,
      accountCollectionKey,
      request,
      "body",
   ...
   */
  public async store_apiNskV1PersonsByPersonKeyAccountCollectionPost(
    personKey: string,
    request?: AccountCollectionRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAccountCollectionPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAccountGet(
    personKey: string,
    headers?: Headers
  ): Promise<Account> {
    const response = await apiNskV1PersonsByPersonKeyAccountGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAccountPost(
    personKey: string,
    request?: CreateAccountRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAccountPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAccountStatusPut(
    personKey: string,
    status: "Open" | "Closed" | "AgencyInactive" | "Unknown",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAccountStatusPut(
      personKey,
      status,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAccountTransactionsGet(
    personKey: string,
    startTime: Date,
    sortByNewest: boolean,
    endTime?: Date,
    ...
    const response = await apiNskV1PersonsByPersonKeyAccountTransactionsGet(
      personKey,
      startTime,
      sortByNewest,
      endTime,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyDelete(
    personKey: string,
    personAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyDelete(
      personKey,
      personAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyGet(
    personKey: string,
    personAddressKey: string,
    headers?: Headers
  ): Promise<PersonAddress> {
    const response = await apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyGet(
      personKey,
      personAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPatch(
    personKey: string,
    personAddressKey: string,
    request?: DeltaMapperPersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPatch(
      personKey,
      personAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPut(
    personKey: string,
    personAddressKey: string,
    request?: PersonAddressEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAddressesByPersonAddressKeyPut(
      personKey,
      personAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonAddress>> {
    const response = await apiNskV1PersonsByPersonKeyAddressesGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAddressesPost(
    personKey: string,
    request?: PersonAddressCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAddressesPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyDelete(
    personKey: string,
    personAliasKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyDelete(
      personKey,
      personAliasKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyGet(
    personKey: string,
    personAliasKey: string,
    headers?: Headers
  ): Promise<PersonAlias> {
    const response = await apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyGet(
      personKey,
      personAliasKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPatch(
    personKey: string,
    personAliasKey: string,
    request?: DeltaMapperPersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPatch(
      personKey,
      personAliasKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPut(
    personKey: string,
    personAliasKey: string,
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAliasesByPersonAliasKeyPut(
      personKey,
      personAliasKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonAlias>> {
    const response = await apiNskV1PersonsByPersonKeyAliasesGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyAliasesPost(
    personKey: string,
    request?: PersonAliasRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyAliasesPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyDelete(
    personKey: string,
    personCommentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyDelete(
      personKey,
      personCommentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyGet(
    personKey: string,
    personCommentKey: string,
    headers?: Headers
  ): Promise<PersonComment> {
    const response = await apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyGet(
      personKey,
      personCommentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPatch(
    personKey: string,
    personCommentKey: string,
    request?: DeltaMapperPersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPatch(
      personKey,
      personCommentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPut(
    personKey: string,
    personCommentKey: string,
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyCommentsByPersonCommentKeyPut(
      personKey,
      personCommentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonComment>> {
    const response = await apiNskV1PersonsByPersonKeyCommentsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyCommentsPost(
    personKey: string,
    request?: PersonCommentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyCommentsPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyDelete(
    personKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyDelete(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyDelete(
    personKey: string,
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyGet(
    personKey: string,
    personEmailAddressKey: string,
    headers?: Headers
  ): Promise<PersonEmail> {
    const response = await apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyGet(
      personKey,
      personEmailAddressKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPatch(
    personKey: string,
    personEmailAddressKey: string,
    request?: DeltaMapperPersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPatch(
      personKey,
      personEmailAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPut(
    personKey: string,
    personEmailAddressKey: string,
    request?: PersonEmailEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyEmailsByPersonEmailAddressKeyPut(
      personKey,
      personEmailAddressKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonEmail>> {
    const response = await apiNskV1PersonsByPersonKeyEmailsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyEmailsPost(
    personKey: string,
    request?: PersonEmailCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyEmailsPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyGet(
    personKey: string,
    headers?: Headers
  ): Promise<Person> {
    const response = await apiNskV1PersonsByPersonKeyGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyDelete(
    personKey: string,
    personInformationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyGet(
    personKey: string,
    personInformationKey: string,
    headers?: Headers
  ): Promise<PersonInformation> {
    const response = await apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyGet(
      personKey,
      personInformationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPatch(
    personKey: string,
    personInformationKey: string,
    request?: DeltaMapperPersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPatch(
      personKey,
      personInformationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPut(
    personKey: string,
    personInformationKey: string,
    request?: PersonInformationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyInformationByPersonInformationKeyPut(
      personKey,
      personInformationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonInformation>> {
    const response = await apiNskV1PersonsByPersonKeyInformationGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyInformationPost(
    personKey: string,
    request?: PersonInformationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyInformationPost(
      personKey,
      request,
      "body",
      headers
   ...
   */
  public async store_apiNskV1PersonsByPersonKeyPatch(
    personKey: string,
    request?: DeltaMapperPersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPatch(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyDelete(
    personKey: string,
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyGet(
    personKey: string,
    personPhoneNumberKey: string,
    headers?: Headers
  ): Promise<PersonPhoneNumber> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyGet(
      personKey,
      personPhoneNumberKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPatch(
    personKey: string,
    personPhoneNumberKey: string,
    request?: DeltaMapperPersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPatch(
      personKey,
      personPhoneNumberKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPut(
    personKey: string,
    personPhoneNumberKey: string,
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersByPersonPhoneNumberKeyPut(
      personKey,
      personPhoneNumberKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonPhoneNumber>> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPhoneNumbersPost(
    personKey: string,
    request?: PersonPhoneNumberRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPhoneNumbersPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyDelete(
    personKey: string,
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyDelete(
      personKey,
      personPreferenceKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyGet(
    personKey: string,
    personPreferenceKey: string,
    headers?: Headers
  ): Promise<PersonPreference> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyGet(
      personKey,
      personPreferenceKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPatch(
    personKey: string,
    personPreferenceKey: string,
    request?: DeltaMapperPersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPatch(
      personKey,
      personPreferenceKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPut(
    personKey: string,
    personPreferenceKey: string,
    request?: PersonPreferenceEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesByPersonPreferenceKeyPut(
      personKey,
      personPreferenceKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonPreference>> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPreferencesPost(
    personKey: string,
    request?: PersonPreferenceCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPreferencesPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyDelete(
    personKey: string,
    personProgramKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyDelete(
      personKey,
      personProgramKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyGet(
    personKey: string,
    personProgramKey: string,
    headers?: Headers
  ): Promise<PersonCustomerProgram> {
    const response = await apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyGet(
      personKey,
      personProgramKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPatch(
    personKey: string,
    personProgramKey: string,
    request?: DeltaMapperPersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPatch(
      personKey,
      personProgramKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPut(
    personKey: string,
    personProgramKey: string,
    request?: PersonCustomerProgramEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyProgramsByPersonProgramKeyPut(
      personKey,
      personProgramKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonCustomerProgram>> {
    const response = await apiNskV1PersonsByPersonKeyProgramsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyProgramsPost(
    personKey: string,
    request?: PersonCustomerProgramCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyProgramsPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyPut(
    personKey: string,
    request?: PersonEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyPut(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyDelete(
    personKey: string,
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyGet(
    personKey: string,
    personStoredPaymentKey: string,
    headers?: Headers
  ): Promise<PersonStoredPayment> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyGet(
      personKey,
      personStoredPaymentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPatch(
    personKey: string,
    personStoredPaymentKey: string,
    request?: DeltaMapperPersonStoredPaymentUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPatch(
      personKey,
      personStoredPaymentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPut(
    personKey: string,
    personStoredPaymentKey: string,
    request?: PersonStoredPaymentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsByPersonStoredPaymentKeyPut(
      personKey,
      personStoredPaymentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonStoredPayment>> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyStoredPaymentsPost(
    personKey: string,
    request?: PersonStoredPaymentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyStoredPaymentsPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyDelete(
    personKey: string,
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyGet(
    personKey: string,
    personTravelDocumentKey: string,
    headers?: Headers
  ): Promise<PersonTravelDocument> {
    const response = await apiNskV1PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyGet(
      personKey,
      personTravelDocumentKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelDocumentsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<PersonTravelDocument>> {
    const response = await apiNskV1PersonsByPersonKeyTravelDocumentsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelDocumentsPost(
    personKey: string,
    request?: PersonTravelDocumentRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelDocumentsPost(
      personKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyDelete(
    personKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyDelete(
      personKey,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
    personKey: string,
    travelNotificationKey: string,
    eventType: "DepartureDelay" | "ArrivalDelay" | "ScheduleChange" | "CheckIn",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
      personKey,
      travelNotificationKey,
      eventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
    personKey: string,
    travelNotificationKey: string,
    eventType: "DepartureDelay" | "ArrivalDelay" | "ScheduleChange" | "CheckIn",
    headers?: Headers
  ): Promise<NotificationEvent> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
      personKey,
      travelNotificationKey,
      eventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsGet(
    personKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationEvent>> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsGet(
      personKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsPost(
    personKey: string,
    travelNotificationKey: string,
    request?: NotificationEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyEventsPost(
      personKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyGet(
    personKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<TravelNotification> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyGet(
      personKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPatch(
    personKey: string,
    travelNotificationKey: string,
    request?: DeltaMapperTravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPatch(
      personKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPut(
    personKey: string,
    travelNotificationKey: string,
    request?: TravelNotificationEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyPut(
      personKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
    personKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
      personKey,
      travelNotificationKey,
      timedEventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
    personKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    headers?: Headers
  ): Promise<NotificationTimedEvent> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
      personKey,
      travelNotificationKey,
      timedEventType,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
    personKey: string,
    travelNotificationKey: string,
    timedEventType: "Departure" | "Arrival",
    ...
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
      personKey,
      travelNotificationKey,
      timedEventType,
      request,
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(
    personKey: string,
    travelNotificationKey: string,
    headers?: Headers
  ): Promise<Array<NotificationTimedEvent>> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(
      personKey,
      travelNotificationKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(
    personKey: string,
    travelNotificationKey: string,
    request?: NotificationTimedEventCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(
      personKey,
      travelNotificationKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsGet(
    personKey: string,
    headers?: Headers
  ): Promise<Array<TravelNotification>> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsGet(
      personKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1PersonsByPersonKeyTravelNotificationsPost(
    personKey: string,
    request?: TravelNotificationCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsByPersonKeyTravelNotificationsPost(
      personKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1PersonsGet(
    ...
    const response = await apiNskV1PersonsGet(
      activeOnly,
      firstName,
      lastName,
      firstNameMatching,
   ...
   *
   */
  public async store_apiNskV1PersonsPost(
    request?: PersonCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1PersonsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPatch(
    personKey: string,
    personTravelDocumentKey: string,
    request?: DeltaMapperTravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPatch(
      personKey,
      personTravelDocumentKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPut(
    personKey: string,
    personTravelDocumentKey: string,
    request?: TravelDocumentEditRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2PersonsByPersonKeyTravelDocumentsByPersonTravelDocumentKeyPut(
      personKey,
      personTravelDocumentKey,
      request,
      "body",
