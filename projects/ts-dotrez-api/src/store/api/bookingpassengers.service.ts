...
export class StoreBookingpassengersService {
  ...
  public async store_apiNskV1BookingPassengersBreakdownByTypeGet(
    ...
    const response = await apiNskV1BookingPassengersBreakdownByTypeGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersBreakdownGet(
    ...
    const response = await apiNskV1BookingPassengersBreakdownGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyDelete(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyDelete(
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(
      passengerAlternateKey,
      travelNotificationKey,
      eventType,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(
      passengerAlternateKey,
      travelNotificationKey,
      eventType,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsGet(
      passengerAlternateKey,
      travelNotificationKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsPost(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsPost(
      passengerAlternateKey,
      travelNotificationKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyGet(
      passengerAlternateKey,
      travelNotificationKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPatch(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPatch(
      passengerAlternateKey,
      travelNotificationKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPut(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPut(
      passengerAlternateKey,
      travelNotificationKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(
      passengerAlternateKey,
      travelNotificationKey,
      timedEventType,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(
      passengerAlternateKey,
      travelNotificationKey,
      timedEventType,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(
      passengerAlternateKey,
      travelNotificationKey,
      timedEventType,
      request,
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(
      passengerAlternateKey,
      travelNotificationKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(
      passengerAlternateKey,
      travelNotificationKey,
      request,
      "body",
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsGet(
      passengerAlternateKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsPost(
    ...
    const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsPost(
      passengerAlternateKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyAddressesByAddressKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyAddressesByAddressKeyGet(
      passengerKey,
      addressKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyAddressesGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyAddressesGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyBaggageByBaggageKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyBaggageByBaggageKeyGet(
      passengerKey,
      baggageKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyBaggageGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyBaggageGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyBreakdownGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyBreakdownGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyGet(
      passengerKey,
      travelDocumentKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyDocumentsGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyDocumentsGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyGet(
      passengerKey,
      travelDocumentKey,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyInfantDocumentsGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyInfantDocumentsGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyInfantGet(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyInfantGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeyPassengerTypeCodePatch(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeyPassengerTypeCodePatch(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV1BookingPassengersByPassengerKeySeatsByUnitKeyDelete(
    ...
    const response = await apiNskV1BookingPassengersByPassengerKeySeatsByUnitKeyDelete(
      passengerKey,
      unitKey,
      waiveFee,
      ignoreSeatSsrs,
  ...
  public async store_apiNskV1BookingPassengersGet(
    ...
    const response = await apiNskV1BookingPassengersGet(
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyDelete(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyDelete(
      passengerKey,
      addressKey,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPatch(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPatch(
      passengerKey,
      addressKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPut(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPut(
      passengerKey,
      addressKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyAddressesPost(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyAddressesPost(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyDelete(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyDelete(
      passengerKey,
      travelDocumentKey,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPatch(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPatch(
      passengerKey,
      travelDocumentKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPut(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPut(
      passengerKey,
      travelDocumentKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyDocumentsPost(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsPost(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantDelete(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantDelete(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyDelete(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyDelete(
      passengerKey,
      travelDocumentKey,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPatch(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPatch(
      passengerKey,
      travelDocumentKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPut(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPut(
      passengerKey,
      travelDocumentKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantDocumentsPost(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsPost(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeyInfantPatch(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeyInfantPatch(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyGet(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyGet(
      passengerKey,
      unitKey,
      "body",
      headers
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyPost(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyPost(
      passengerKey,
      unitKey,
      request,
      "body",
  ...
  public async store_apiNskV2BookingPassengersByPassengerKeySeatsGet(
    ...
    const response = await apiNskV2BookingPassengersByPassengerKeySeatsGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV3BookingPassengersByPassengerKeyInfantPost(
    ...
    const response = await apiNskV3BookingPassengersByPassengerKeyInfantPost(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV3BookingPassengersByPassengerKeyInfantPut(
    ...
    const response = await apiNskV3BookingPassengersByPassengerKeyInfantPut(
      passengerKey,
      request,
      "body",
      headers
  ...
  public async store_apiNskV3BookingPassengersByPassengerKeyPatch(
    ...
    const response = await apiNskV3BookingPassengersByPassengerKeyPatch(
      passengerKey,
      waiveNameChangeFees,
      request,
      "body",
  ...
  public async store_apiNskV3BookingPassengersByPassengerKeyPut(
    ...
    const response = await apiNskV3BookingPassengersByPassengerKeyPut(
      passengerKey,
      waiveNameChangeFees,
      request,
      "body",
