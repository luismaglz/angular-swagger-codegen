...
import {
        apiNskV1BookingPassengersBreakdownByTypeGet,
        apiNskV1BookingPassengersBreakdownGet,
        ...
        apiNskV1BookingPassengersByPassengerKeyGet,
...
export class StoreBookingpassengersService {
    ...
    {
        const response = await apiNskV1BookingPassengersBreakdownByTypeGet('body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersBreakdownGet('body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyDelete(passengerAlternateKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeDelete(passengerAlternateKey,travelNotificationKey,eventType,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsByEventTypeGet(passengerAlternateKey,travelNotificationKey,eventType,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsGet(passengerAlternateKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyEventsPost(passengerAlternateKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyGet(passengerAlternateKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPatch(passengerAlternateKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyPut(passengerAlternateKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeDelete(passengerAlternateKey,travelNotificationKey,timedEventType,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypeGet(passengerAlternateKey,travelNotificationKey,timedEventType,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsByTimedEventTypePut(passengerAlternateKey,travelNotificationKey,timedEventType,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsGet(passengerAlternateKey,travelNotificationKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsByTravelNotificationKeyTimedEventsPost(passengerAlternateKey,travelNotificationKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsGet(passengerAlternateKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerAlternateKeyTravelNotificationsPost(passengerAlternateKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyAddressesByAddressKeyGet(passengerKey,addressKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyAddressesGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyBaggageByBaggageKeyGet(passengerKey,baggageKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyBaggageGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyBreakdownGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyGet(passengerKey,travelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyDocumentsGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyGet(passengerKey,travelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyInfantDocumentsGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyInfantGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeyPassengerTypeCodePatch(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersByPassengerKeySeatsByUnitKeyDelete(passengerKey,unitKey,waiveFee,ignoreSeatSsrs,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV1BookingPassengersGet('body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyDelete(passengerKey,addressKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPatch(passengerKey,addressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyAddressesByAddressKeyPut(passengerKey,addressKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyAddressesPost(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyDelete(passengerKey,travelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPatch(passengerKey,travelDocumentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsByTravelDocumentKeyPut(passengerKey,travelDocumentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyDocumentsPost(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantDelete(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyDelete(passengerKey,travelDocumentKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPatch(passengerKey,travelDocumentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsByTravelDocumentKeyPut(passengerKey,travelDocumentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantDocumentsPost(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeyInfantPatch(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyGet(passengerKey,unitKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeySeatsByUnitKeyPost(passengerKey,unitKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV2BookingPassengersByPassengerKeySeatsGet(passengerKey,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV3BookingPassengersByPassengerKeyInfantPost(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV3BookingPassengersByPassengerKeyInfantPut(passengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV3BookingPassengersByPassengerKeyPatch(passengerKey,waiveNameChangeFees,request,'body', headers).toPromise();
    ...
    {
        const response = await apiNskV3BookingPassengersByPassengerKeyPut(passengerKey,waiveNameChangeFees,request,'body', headers).toPromise();
