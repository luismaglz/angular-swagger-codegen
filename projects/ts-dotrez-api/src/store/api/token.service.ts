...
export class StoreTokenService {
  ...
  public async store_apiNskV1TokenCulturePost(
    ...
    const response = await apiNskV1TokenCulturePost(
      defaultCultureCode,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1TokenPost(
    ...
    const response = await apiNskV1TokenPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1TokenPut(
    ...
    const response = await apiNskV1TokenPut(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1TokenServerTransferPost(
    ...
    const response = await apiNskV1TokenServerTransferPost(
      request,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1TokenSingleSignOnPost(
    ...
    const response = await apiNskV1TokenSingleSignOnPost(
      credentials,
      "body",
      headers
    ).toPromise();
  ...
  public async store_apiNskV1TokenSingleSignOnPut(
    ...
    const response = await apiNskV1TokenSingleSignOnPut(
      credentials,
      "body",
      headers
    ).toPromise();
