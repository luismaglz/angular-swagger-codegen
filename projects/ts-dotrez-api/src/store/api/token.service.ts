...
export class StoreTokenService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("TokenService") protected baseService:TokenService) {}
    ...
    {
        const response = await this.baseService.apiNskV1TokenCulturePost(defaultCultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenPut(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenServerTransferPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenSingleSignOnPost(credentials,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1TokenSingleSignOnPut(credentials,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1TokenDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1TokenPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiV1TokenPut('body', headers).toPromise();
