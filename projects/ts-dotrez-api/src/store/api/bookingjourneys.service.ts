...
export class StoreBookingjourneysService {
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyBundlesPost(
    journeyKey: string,
    request?: BundleSellRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingJourneysByJourneyKeyBundlesPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyDelete(
    journeyKey: string,
    request?: CancelJourneyRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingJourneysByJourneyKeyDelete(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyGet(
    journeyKey: string,
    headers?: Headers
  ): Promise<Journey> {
    const response = await apiNskV1BookingJourneysByJourneyKeyGet(
      journeyKey,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyAddressRequirementsGet(
    journeyKey: string,
    passengerKey: string,
    headers?: Headers
  ): Promise<boolean> {
    const response = await apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyAddressRequirementsGet(
      journeyKey,
      passengerKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageByBaggageKeyDelete(
    journeyKey: string,
    passengerKey: string,
    baggageKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageByBaggageKeyDelete(
      journeyKey,
      passengerKey,
      baggageKey,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageByBaggageKeyGet(
    journeyKey: string,
    passengerKey: string,
    baggageKey: string,
    headers?: Headers
  ): Promise<Array<PassengerBag>> {
    const response = await apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageByBaggageKeyGet(
      journeyKey,
      passengerKey,
      baggageKey,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageGet(
    journeyKey: string,
    passengerKey: string,
    headers?: Headers
  ): Promise<Array<PassengerBag>> {
    const response = await apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggageGet(
      journeyKey,
      passengerKey,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggagePost(
    journeyKey: string,
    passengerKey: string,
    request?: PassengerBagRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingJourneysByJourneyKeyPassengersByPassengerKeyBaggagePost(
      journeyKey,
      passengerKey,
      request,
      "body",
   ...
   */
  public async store_apiNskV1BookingJourneysByJourneyKeyTravelDocumentRequirementsGet(
    journeyKey: string,
    headers?: Headers
  ): Promise<TravelDocumentRequirements> {
    const response = await apiNskV1BookingJourneysByJourneyKeyTravelDocumentRequirementsGet(
      journeyKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingJourneysDelete(
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingJourneysDelete(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingJourneysGet(
    headers?: Headers
  ): Promise<Array<Journey>> {
    const response = await apiNskV1BookingJourneysGet(
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1BookingJourneysPassengersByPassengerKeyAddressRequirementsGet(
    passengerKey: string,
    headers?: Headers
  ): Promise<boolean> {
    const response = await apiNskV1BookingJourneysPassengersByPassengerKeyAddressRequirementsGet(
      passengerKey,
      "body",
      headers
    ).toPromise();
   ...
   * This endpoint will return a response containing a collection of travel document type codes that could fulfill  a travel document requirement.  If the \&quot;AtLeastOneDocumentRequired\&quot; value is true, then one or more documents  in the list are required.  However, it does not mean that every document in the list is required.  If  \&quot;AtLeastOneDocumentRequired\&quot; is false, then the list of document type codes represents a list of acceptable  travel documents, but nothing is required.                This endpoint does not determine if any passengers already have required travel documents.
   */
  public async store_apiNskV1BookingJourneysTravelDocumentRequirementsGet(
    headers?: Headers
  ): Promise<TravelDocumentRequirements> {
    const response = await apiNskV1BookingJourneysTravelDocumentRequirementsGet(
      "body",
      headers
    ).toPromise();
