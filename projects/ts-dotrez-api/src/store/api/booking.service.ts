...
export class StoreBookingService {
    ...
    constructor(@inject("Store") protected store: Store<any>, @inject("BookingService") protected baseService:BookingService) {}
    ...
    {
        const response = await this.baseService.apiNskV1BookingAccountCollectionByAccountCollectionKeyTransactionsGet(accountCollectionKey,startTime,sortByNewest,endTime,pageSize,pageIndex,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAccountGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAccountTransactionsGet(startTime,sortByNewest,endTime,pageSize,pageIndex,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddOnsActivitiesGet(vendorCode,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddOnsCarsGet(vendorCode,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddOnsHotelsGet(vendorCode,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddOnsInsuranceGet(vendorCode,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddOnsInsurancePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyCustomerPatch(addOnKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyCustomerPut(addOnKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyDelete(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyGet(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPatch(addOnKey,participantKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPut(addOnKey,participantKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyPaymentsGet(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyPaymentsPost(addOnKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyPreCancelGet(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeySyncPut(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsByAddOnKeyValidationGet(addOnKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingAddonsPaymentsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingBaggageAllowancesGet(includeUsageDetails,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingBundleAvailabilityPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingCommentsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFareOverrideJourneyByJourneyKeyPost(journeyKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFareRulesFareByFareKeyGet(fareKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFareRulesGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFareRulesJourneyByJourneyKeyGet(journeyKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFareRulesSegmentBySegmentKeyGet(segmentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFeeByFeeKeyDelete(feeKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFeeByFeeKeyPut(feeKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFeeGet(feeCode,passengerKey,origin,collectedCurrencyCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingFeePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistoryFlightMoveGet(lastPageKey,pageSize,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistoryGet(event,lastPageKey,pageSize,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistoryMessageGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistoryNotificationGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistorySeatAssignmentGet(event,lastPageKey,pageSize,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingHistorySegmentChangeGet(event,lastPageKey,pageSize,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPointOfSalePatch(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPointOfSalePut(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPromotionDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPromotionPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingPromotionPut(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingQueueDelete(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingQueuePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsByRecordLocatorKeyDelete(recordLocatorKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsByRecordLocatorKeyGet(recordLocatorKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsByRecordLocatorKeyPatch(recordLocatorKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsByRecordLocatorKeyPut(recordLocatorKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingRecordLocatorsPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingResetDelete('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSalesChannelPut(channelType,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSeatsAutoByPrimaryPassengerKeyJourneyByJourneyKeyPost(primaryPassengerKey,journeyKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSeatsAutoByPrimaryPassengerKeyPost(primaryPassengerKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSeatsAutoByPrimaryPassengerKeySegmentBySegmentKeyPost(primaryPassengerKey,segmentKey,request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV1BookingSegmentsBySegmentKeyDelete(segmentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingCommentsByCommentKeyDelete(commentKey,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingDividePost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingHoldAvailableGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingSeatmapsGet(includePropertyLookup,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingSeatmapsSegmentBySegmentKeyGet(segmentKey,includePropertyLookup,cultureCode,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV2BookingStatusGet('body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPost(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingPut(request,'body', headers).toPromise();
    ...
    {
        const response = await this.baseService.apiNskV3BookingSeatmapsJourneyByJourneyKeyGet(journeyKey,includePropertyLookup,cultureCode,'body', headers).toPromise();
