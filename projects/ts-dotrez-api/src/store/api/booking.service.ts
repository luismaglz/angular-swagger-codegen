...
export class StoreBookingService {
   ...
   *
   */
  public async store_apiNskV1BookingAccountCollectionByAccountCollectionKeyTransactionsGet(
    ...
    const response = await apiNskV1BookingAccountCollectionByAccountCollectionKeyTransactionsGet(
   ...
   *
   */
  public async store_apiNskV1BookingAccountGet(
    headers?: Headers
  ): Promise<Account> {
    const response = await apiNskV1BookingAccountGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAccountTransactionsGet(
    startTime: Date,
    sortByNewest: boolean,
    endTime?: Date,
    pageSize?: number,
    ...
    const response = await apiNskV1BookingAccountTransactionsGet(
      startTime,
      sortByNewest,
      endTime,
      pageSize,
   ...
   *
   */
  public async store_apiNskV1BookingAddOnsActivitiesGet(
    vendorCode?: string,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<ActivityProduct>> {
    const response = await apiNskV1BookingAddOnsActivitiesGet(
      vendorCode,
      cultureCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddOnsCarsGet(
    vendorCode?: string,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<CarProduct>> {
    const response = await apiNskV1BookingAddOnsCarsGet(
      vendorCode,
      cultureCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddOnsHotelsGet(
    vendorCode?: string,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<HotelProduct>> {
    const response = await apiNskV1BookingAddOnsHotelsGet(
      vendorCode,
      cultureCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddOnsInsuranceGet(
    vendorCode?: string,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<InsuranceProduct>> {
    const response = await apiNskV1BookingAddOnsInsuranceGet(
      vendorCode,
      cultureCode,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddOnsInsurancePost(
    request?: SellInsuranceRequest,
    headers?: Headers
  ): Promise<IActionResult> {
    const response = await apiNskV1BookingAddOnsInsurancePost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyCustomerPatch(
    addOnKey: string,
    request?: DeltaMapperConsumer,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyCustomerPatch(
      addOnKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyCustomerPut(
    addOnKey: string,
    request?: Consumer,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyCustomerPut(
      addOnKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyDelete(
    addOnKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyDelete(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyGet(
    addOnKey: string,
    headers?: Headers
  ): Promise<AddOn> {
    const response = await apiNskV1BookingAddonsByAddOnKeyGet(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPatch(
    addOnKey: string,
    participantKey: string,
    request?: DeltaMapperOrderParticipantUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPatch(
      addOnKey,
      participantKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPut(
    addOnKey: string,
    participantKey: string,
    request?: OrderParticipantUpdateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyParticipantsByParticipantKeyPut(
      addOnKey,
      participantKey,
      request,
      "body",
   ...
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyPaymentsGet(
    addOnKey: string,
    headers?: Headers
  ): Promise<AddOnAllowedPayments> {
    const response = await apiNskV1BookingAddonsByAddOnKeyPaymentsGet(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyPaymentsPost(
    addOnKey: string,
    request?: OrderPaymentBase,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeyPaymentsPost(
      addOnKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyPreCancelGet(
    addOnKey: string,
    headers?: Headers
  ): Promise<PreCancelDetail> {
    const response = await apiNskV1BookingAddonsByAddOnKeyPreCancelGet(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeySyncPut(
    addOnKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingAddonsByAddOnKeySyncPut(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsByAddOnKeyValidationGet(
    addOnKey: string,
    headers?: Headers
  ): Promise<AddOnSettings> {
    const response = await apiNskV1BookingAddonsByAddOnKeyValidationGet(
      addOnKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsGet(
    headers?: Headers
  ): Promise<InlineResponse200> {
    const response = await apiNskV1BookingAddonsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingAddonsPaymentsGet(
    headers?: Headers
  ): Promise<InlineResponse2001> {
    const response = await apiNskV1BookingAddonsPaymentsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingBaggageAllowancesGet(
    includeUsageDetails?: boolean,
    headers?: Headers
  ): Promise<InlineResponse2002> {
    const response = await apiNskV1BookingBaggageAllowancesGet(
      includeUsageDetails,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1BookingBundleAvailabilityPost(
    request?: BundleAvailabilityRequest,
    headers?: Headers
  ): Promise<Array<BundleAvailability>> {
    const response = await apiNskV1BookingBundleAvailabilityPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingCommentsGet(
    headers?: Headers
  ): Promise<Array<BookingComment>> {
    const response = await apiNskV1BookingCommentsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFareOverrideJourneyByJourneyKeyPost(
    journeyKey: string,
    request?: FareOverrideRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingFareOverrideJourneyByJourneyKeyPost(
      journeyKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingFareRulesFareByFareKeyGet(
    fareKey: string,
    headers?: Headers
  ): Promise<FareRule> {
    const response = await apiNskV1BookingFareRulesFareByFareKeyGet(
      fareKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFareRulesGet(
    headers?: Headers
  ): Promise<Array<FareRule>> {
    const response = await apiNskV1BookingFareRulesGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFareRulesJourneyByJourneyKeyGet(
    journeyKey: string,
    headers?: Headers
  ): Promise<Array<FareRule>> {
    const response = await apiNskV1BookingFareRulesJourneyByJourneyKeyGet(
      journeyKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFareRulesSegmentBySegmentKeyGet(
    segmentKey: string,
    headers?: Headers
  ): Promise<Array<FareRule>> {
    const response = await apiNskV1BookingFareRulesSegmentBySegmentKeyGet(
      segmentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFeeByFeeKeyDelete(
    feeKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingFeeByFeeKeyDelete(
      feeKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingFeeByFeeKeyPut(
    feeKey: string,
    request?: FeeRequestBase,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingFeeByFeeKeyPut(
      feeKey,
      request,
      "body",
      headers
   ...
   */
  public async store_apiNskV1BookingFeeGet(
    feeCode: string,
    passengerKey?: string,
    origin?: string,
    collectedCurrencyCode?: string,
    headers?: Headers
  ): Promise<Array<ServiceCharge>> {
    const response = await apiNskV1BookingFeeGet(
      feeCode,
      passengerKey,
      origin,
   ...
   */
  public async store_apiNskV1BookingFeePost(
    request?: CommitPassengerFeeRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingFeePost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingHistoryFlightMoveGet(
    lastPageKey?: string,
    pageSize?: number,
    headers?: Headers
  ): Promise<FlightMoveHistoryResponse> {
    const response = await apiNskV1BookingHistoryFlightMoveGet(
      lastPageKey,
      pageSize,
      "body",
      headers
  ...
  public async store_apiNskV1BookingHistoryGet(
    ...
    const response = await apiNskV1BookingHistoryGet(
      event,
      lastPageKey,
      pageSize,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingHistoryMessageGet(
    headers?: Headers
  ): Promise<Array<BookingMessageHistory>> {
    const response = await apiNskV1BookingHistoryMessageGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingHistoryNotificationGet(
    headers?: Headers
  ): Promise<Array<BookingNotificationHistory>> {
    const response = await apiNskV1BookingHistoryNotificationGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingHistorySeatAssignmentGet(
    event: "AssignedSeat" | "RemoveSeat",
    lastPageKey?: string,
    pageSize?: number,
    headers?: Headers
  ): Promise<SeatAssignmentHistoryResponse> {
    const response = await apiNskV1BookingHistorySeatAssignmentGet(
      event,
      lastPageKey,
      pageSize,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingHistorySegmentChangeGet(
    event: "AddedFlight" | "DeletedFlight",
    lastPageKey?: string,
    pageSize?: number,
    headers?: Headers
  ): Promise<SegmentChangeHistoryResponse> {
    const response = await apiNskV1BookingHistorySegmentChangeGet(
      event,
      lastPageKey,
      pageSize,
      "body",
   ...
   */
  public async store_apiNskV1BookingPointOfSalePatch(
    request?: DeltaMapperBookingPointOfSaleEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingPointOfSalePatch(
      request,
      "body",
      headers
    ).toPromise();
   ...
   * The ISO country code cannot be updated for a committed booking.  This value can only be  updated on an uncommitted booking.
   */
  public async store_apiNskV1BookingPointOfSalePut(
    request?: BookingPointOfSaleEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingPointOfSalePut(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingPromotionDelete(
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingPromotionDelete(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingPromotionPost(
    request?: PromotionRequest,
    headers?: Headers
  ): Promise<any> {
    const response = await apiNskV1BookingPromotionPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingPromotionPut(
    request?: PromotionRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingPromotionPut(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingQueueDelete(
    request?: BookingQueueRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingQueueDelete(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingQueuePost(
    request?: BookingQueueRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingQueuePost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsByRecordLocatorKeyDelete(
    recordLocatorKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingRecordLocatorsByRecordLocatorKeyDelete(
      recordLocatorKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsByRecordLocatorKeyGet(
    recordLocatorKey: string,
    headers?: Headers
  ): Promise<RecordLocator> {
    const response = await apiNskV1BookingRecordLocatorsByRecordLocatorKeyGet(
      recordLocatorKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsByRecordLocatorKeyPatch(
    recordLocatorKey: string,
    request?: DeltaMapperRecordLocatorEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingRecordLocatorsByRecordLocatorKeyPatch(
      recordLocatorKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsByRecordLocatorKeyPut(
    recordLocatorKey: string,
    request?: RecordLocatorEditRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingRecordLocatorsByRecordLocatorKeyPut(
      recordLocatorKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsDelete(
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingRecordLocatorsDelete(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsGet(
    headers?: Headers
  ): Promise<Array<RecordLocator>> {
    const response = await apiNskV1BookingRecordLocatorsGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingRecordLocatorsPost(
    request?: RecordLocatorCreateRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingRecordLocatorsPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingResetDelete(
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingResetDelete(
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV1BookingSalesChannelPut(
    channelType?: "Direct" | "Web" | "Api",
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingSalesChannelPut(
      channelType,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV1BookingSeatsAutoByPrimaryPassengerKeyJourneyByJourneyKeyPost(
    primaryPassengerKey: string,
    journeyKey: string,
    request?: AutoAssignRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingSeatsAutoByPrimaryPassengerKeyJourneyByJourneyKeyPost(
      primaryPassengerKey,
      journeyKey,
      request,
      "body",
   ...
   *
   */
  public async store_apiNskV1BookingSeatsAutoByPrimaryPassengerKeyPost(
    primaryPassengerKey: string,
    request?: AutoAssignRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingSeatsAutoByPrimaryPassengerKeyPost(
      primaryPassengerKey,
      request,
      "body",
      headers
   ...
   *
   */
  public async store_apiNskV1BookingSeatsAutoByPrimaryPassengerKeySegmentBySegmentKeyPost(
    primaryPassengerKey: string,
    segmentKey: string,
    request?: AutoAssignRequest,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingSeatsAutoByPrimaryPassengerKeySegmentBySegmentKeyPost(
      primaryPassengerKey,
      segmentKey,
      request,
      "body",
   ...
   */
  public async store_apiNskV1BookingSegmentsBySegmentKeyDelete(
    segmentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV1BookingSegmentsBySegmentKeyDelete(
      segmentKey,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2BookingCommentsByCommentKeyDelete(
    commentKey: string,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2BookingCommentsByCommentKeyDelete(
      commentKey,
      "body",
      headers
    ).toPromise();
   ...
   */
  public async store_apiNskV2BookingDividePost(
    request?: DivideRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV2BookingDividePost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2BookingHoldAvailableGet(
    headers?: Headers
  ): Promise<Date> {
    const response = await apiNskV2BookingHoldAvailableGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV2BookingSeatmapsGet(
    includePropertyLookup?: boolean,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<SeatMapAvailability>> {
    const response = await apiNskV2BookingSeatmapsGet(
   ...
   *
   */
  public async store_apiNskV2BookingSeatmapsSegmentBySegmentKeyGet(
    segmentKey: string,
    includePropertyLookup?: boolean,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<SeatMapAvailability>> {
    const response = await apiNskV2BookingSeatmapsSegmentBySegmentKeyGet(
      segmentKey,
      includePropertyLookup,
      cultureCode,
      "body",
   ...
   */
  public async store_apiNskV2BookingStatusGet(
    headers?: Headers
  ): Promise<Booking> {
    const response = await apiNskV2BookingStatusGet(
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV3BookingPost(
    request?: CommitRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV3BookingPost(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV3BookingPut(
    request?: CommitRequestv2,
    headers?: Headers
  ): Promise<IJsonResponse> {
    const response = await apiNskV3BookingPut(
      request,
      "body",
      headers
    ).toPromise();
   ...
   *
   */
  public async store_apiNskV3BookingSeatmapsJourneyByJourneyKeyGet(
    journeyKey: string,
    includePropertyLookup?: boolean,
    cultureCode?: string,
    headers?: Headers
  ): Promise<Array<SeatMapAvailability>> {
    const response = await apiNskV3BookingSeatmapsJourneyByJourneyKeyGet(
      journeyKey,
      includePropertyLookup,
      cultureCode,
      "body",
