...
export class ApiServiceBinder {
    ...
    public static withBookingboardingpassesService(container: interfaces.Container) {
    ...
    public static withOneTimeTravelNotificationsService(container: interfaces.Container) {
