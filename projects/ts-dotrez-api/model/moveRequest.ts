 ...
 */
    ...
    import { MoveRequest<CAP>moveType</CAP> } from '../types/enums';
    import { MoveRequest<CAP>ignoreLiftStatus</CAP> } from '../types/enums';
    import { MoveRequest<CAP>moveSsrOption</CAP> } from '../types/enums';
...
export interface MoveRequest { 
     ...
     */
    moveType?: <ENUM>'None'|'Irop'|'Diversion'|'FlightClose'|'FlyAhead'|'SplitJourney'|'SelfServiceRebooking'</ENUM>;
    /**
     ...
     */
    ignoreLiftStatus?: <ENUM>'IgnoreNotAllowed'|'IgnoreCheckin'|'IgnoreBoarded'</ENUM>;
    /**
     ...
     */
    moveSsrOption?: <ENUM>'OverbookSsr'|'MoveAvailableSsr'|'MoveNone'</ENUM>;
}
